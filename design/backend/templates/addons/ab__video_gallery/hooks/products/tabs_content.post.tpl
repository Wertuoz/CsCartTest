...
<td class="{$no_hide_input_if_shared_product}">
{include file="common/select_popup.tpl" popup_additional_class="dropleft" id=$video.video_id status=$video.status hidden=true object_id_name="video_id" table="ab__video_gallery"}
</td>
...
<div class="control-group">
<label class="control-label" for="ab__vg__width__{$_key}">{__("ab__vg.form.width")}{include file="common/tooltip.tpl" tooltip=__("ab__vg.form.width.tooltip")}</label>
<div class="controls">
<input type="text" name="product_data[ab__vg_videos][{$_key}][width]" id="ab__vg__width__{$_key}" size="55" value="{$video.width}" />
</div>
</div>
<div class="control-group">
<label class="control-label" for="ab__vg__height__{$_key}">{__("ab__vg.form.height")}{include file="common/tooltip.tpl" tooltip=__("ab__vg.form.height.tooltip")}</label>
<div class="controls">
<input type="text" name="product_data[ab__vg_videos][{$_key}][height]" id="ab__vg__height__{$_key}" size="55" value="{$video.height}" />
</div>
</div>
<div class="control-group">
...
<div class="control-group">
<label class="control-label" for="ab__vg__width__{$new_key}">{__("ab__vg.form.width")}{include file="common/tooltip.tpl" tooltip=__("ab__vg.form.width.tooltip")}</label>
<div class="controls">
<input type="text" name="product_data[ab__vg_videos][{$new_key}][width]" id="ab__vg__width__{$new_key}" size="55" value="" />
</div>
</div>
<div class="control-group">
<label class="control-label" for="ab__vg__height__{$new_key}">{__("ab__vg.form.height")}{include file="common/tooltip.tpl" tooltip=__("ab__vg.form.height.tooltip")}</label>
<div class="controls">
<input type="text" name="product_data[ab__vg_videos][{$new_key}][height]" id="ab__vg__height__{$new_key}" size="55" value="" />
</div>
</div>
<div class="control-group">
