<div class="clearfix ty-checkout-select-store__map-full-div" style="width: 100%">
    {if $store_count > 1}
        ...
        >
            {include file="buttons/button.tpl" but_role="text" but_meta="cm-map-view-locations ty-btn__tertiary" but_text=__("addons.lite_checkout.shippings.show_all_on_map")}
        </div>
        </h3>
    {/if}
