...
<div class="litecheckout__fields-row">
    <div class="control-group litecheckout__field litecheckout__field--full">
        <input type="tel" class="litecheckout__input" name="payment_info[phone]" id="phone_customer" {if $account_params.phone}value="{$account_params.phone}"{else}value=""{/if} size="20" placeholder=" " />
        <label for="phone_customer" class="ty-control-group__title litecheckout__label">{__("phone")}</label>
    </div>
