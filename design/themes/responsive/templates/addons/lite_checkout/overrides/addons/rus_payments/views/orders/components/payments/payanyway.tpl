...
{elseif $payment_method.processor_params.payment_system == "euroset"}
	<div class="litecheckout__fields-row">
		<div class="control-group litecheckout__field litecheckout__field--full">
			<input class="input-text cm-autocomplete-off litecheckout__input" type="tel" id="rapida_phone" name="payment_info[rapidaPhone]" value="" size="35" placeholder=" " />
			<label class="cm-required cm-regexp litecheckout__label" for="rapida_phone">{__("rapidaphone")}</label>
		</div>
	</div>
