<?php /* Smarty version Smarty-3.1.21, created on 2018-12-26 14:57:58
         compiled from "/srv/www/esportshop.ru/design/themes/abt__unitheme/templates/views/categories/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6982941415c236cc61fd080-61148869%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '44ed4e4905cf82a8e02d76082b9361f5520a1623' => 
    array (
      0 => '/srv/www/esportshop.ru/design/themes/abt__unitheme/templates/views/categories/view.tpl',
      1 => 1545825029,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '6982941415c236cc61fd080-61148869',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c236cc62c3ce3_62174347',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c236cc62c3ce3_62174347')) {function content_5c236cc62c3ce3_62174347($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/block.hook.php';
...
<div class="cat-view-grid" id="category_products_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block']->value['block_id'], ENT_QUOTES, 'ISO-8859-1');?>
">

    <?php if ($_smarty_tpl->tpl_vars['subcategories']->value&&$_smarty_tpl->tpl_vars['settings']->value['abt__unitheme']['hide_subcategories_in_category']['value']=='N') {?>
...
><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value['category'], ENT_QUOTES, 'ISO-8859-1');?>
                ...
                <?php } ?>
            <?php } ?>
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"ab__seo_filters:subcategories_post")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"ab__seo_filters:subcategories_post"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();
$_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"ab__seo_filters:subcategories_post"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php }?>
<?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"ab__seo_filters:category_description")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"ab__seo_filters:category_description"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

<?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"ab__multiple_cat_descriptions:category_description")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"ab__multiple_cat_descriptions:category_description"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
<?php if ($_smarty_tpl->tpl_vars['category_data']->value['description']||$_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['live_editor']) {?>
    <div class="ab-category-description ty-wysiwyg-content ty-mb-l" <?php echo smarty_function_live_edit(array('name'=>"category:description:".((string)$_smarty_tpl->tpl_vars['category_data']->value['category_id'])),$_smarty_tpl);?>
><?php echo $_smarty_tpl->tpl_vars['category_data']->value['description'];?>
</div>
<?php }?>
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"ab__multiple_cat_descriptions:category_description"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>

<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"ab__seo_filters:category_description"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
