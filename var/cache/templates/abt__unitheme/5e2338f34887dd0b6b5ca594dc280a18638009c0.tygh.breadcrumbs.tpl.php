<?php /* Smarty version Smarty-3.1.21, created on 2018-12-26 14:54:23
         compiled from "/srv/www/esportshop.ru/design/themes/abt__unitheme/templates/common/breadcrumbs.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20742523475c236bef75bad1-18771996%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5e2338f34887dd0b6b5ca594dc280a18638009c0' => 
    array (
      0 => '/srv/www/esportshop.ru/design/themes/abt__unitheme/templates/common/breadcrumbs.tpl',
      1 => 1545825029,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '20742523475c236bef75bad1-18771996',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c236bef7ace59_58300150',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c236bef7ace59_58300150')) {function content_5c236bef7ace59_58300150($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_sizeof')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/modifier.sizeof.php';
...
if ($_smarty_tpl->tpl_vars['key']->value!="0") {?><span class="ty-breadcrumbs__slash">/</span><?php }?><span <?php if ($_smarty_tpl->tpl_vars['bc']->value['link']) {?>itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"<?php }?>><?php if ($_smarty_tpl->tpl_vars['bc']->value['link']) {?><a itemprop="item" href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['bc']->value['link']), ENT_QUOTES, 'ISO-8859-1');?>
...
</bdi></a><?php } else { ?><span class="ty-breadcrumbs__current"><bdi><?php echo htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['bc']->value['title']), ENT_QUOTES, 'ISO-8859-1', true);?>
</bdi></span><?php }?></span><?php }
