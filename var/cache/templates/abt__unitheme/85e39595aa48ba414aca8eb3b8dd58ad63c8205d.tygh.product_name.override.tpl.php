<?php /* Smarty version Smarty-3.1.21, created on 2018-12-26 14:52:08
         compiled from "/srv/www/esportshop.ru/design/themes/responsive/templates/addons/wishlist/hooks/products/product_name.override.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15949755975c236b68e34bf2-41262004%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '85e39595aa48ba414aca8eb3b8dd58ad63c8205d' => 
    array (
      0 => '/srv/www/esportshop.ru/design/themes/responsive/templates/addons/wishlist/hooks/products/product_name.override.tpl',
      1 => 1543002778,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '15949755975c236b68e34bf2-41262004',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c236b68e7a664_20709882',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c236b68e7a664_20709882')) {function content_5c236b68e7a664_20709882($_smarty_tpl) {?><?php if (!is_callable('smarty_function_live_edit')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/function.live_edit.php';
...
<?php if ($_smarty_tpl->tpl_vars['show_name']->value) {?>
    <?php if ($_smarty_tpl->tpl_vars['hide_links']->value) {?><strong><?php } else { ?><a href="<?php ob_start();
if ($_smarty_tpl->tpl_vars['product']->value['combination']) {?><?php echo "&combination=";?><?php echo (string)$_smarty_tpl->tpl_vars['product']->value['combination'];?><?php }
$_tmp5=ob_get_clean();?><?php echo htmlspecialchars(fn_url("products.view?product_id=".((string)$_smarty_tpl->tpl_vars['product']->value['product_id']).$_tmp5), ENT_QUOTES, 'ISO-8859-1');?>
" class="product-title" title="<?php echo htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['product']->value['product']), ENT_QUOTES, 'ISO-8859-1');?>
" <?php echo smarty_function_live_edit(array('name'=>"product:product:".((string)$_smarty_tpl->tpl_vars['product']->value['product_id']),'phrase'=>$_smarty_tpl->tpl_vars['product']->value['product']),$_smarty_tpl);?>
><?php }
echo $_smarty_tpl->tpl_vars['product']->value['product'];
