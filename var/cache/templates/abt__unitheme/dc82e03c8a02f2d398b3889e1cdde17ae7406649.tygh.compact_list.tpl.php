<?php /* Smarty version Smarty-3.1.21, created on 2018-12-26 14:57:49
         compiled from "/srv/www/esportshop.ru/design/themes/abt__unitheme/templates/blocks/list_templates/compact_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12823201285c236cbdb50e22-91619242%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dc82e03c8a02f2d398b3889e1cdde17ae7406649' => 
    array (
      0 => '/srv/www/esportshop.ru/design/themes/abt__unitheme/templates/blocks/list_templates/compact_list.tpl',
      1 => 1545825029,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '12823201285c236cbdb50e22-91619242',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c236cbdc610e7_07328622',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c236cbdc610e7_07328622')) {function content_5c236cbdc610e7_07328622($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/function.script.php';
...
?>
            ...
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:product_compact_list")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:product_compact_list"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                ...
                <div class="ty-compact-list__item">
                    <form <?php if (!$_smarty_tpl->tpl_vars['config']->value['tweaks']['disable_dhtml']) {?>class="cm-ajax cm-ajax-full-render"<?php }?>
...
if ($_smarty_tpl->tpl_vars['product']->value['discussion_amount_posts']>0) {?><span class="cn-comments">(<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['discussion_amount_posts'], ENT_QUOTES, 'ISO-8859-1');?>
                                    ...
                                    <?php } else { ?>
                                        <div class="compact-list__rating no-rating"><i class="ty-icon-star-empty"></i><i class="ty-icon-star-empty"></i><i class="ty-icon-star-empty"></i><i class="ty-icon-star-empty"></i><i class="ty-icon-star-empty"></i><?php if ($_smarty_tpl->tpl_vars['product']->value['discussion_amount_posts']>0) {?><span class="cn-comments">(<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['discussion_amount_posts'], ENT_QUOTES, 'ISO-8859-1');?>
)</span><?php }?></div>
                                    <?php }?>
