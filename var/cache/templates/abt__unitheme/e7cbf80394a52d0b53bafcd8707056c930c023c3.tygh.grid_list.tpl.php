<?php /* Smarty version Smarty-3.1.21, created on 2018-12-26 14:52:14
         compiled from "/srv/www/esportshop.ru/design/themes/abt__unitheme/templates/blocks/list_templates/grid_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20607334305c236b6e735089-38343745%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e7cbf80394a52d0b53bafcd8707056c930c023c3' => 
    array (
      0 => '/srv/www/esportshop.ru/design/themes/abt__unitheme/templates/blocks/list_templates/grid_list.tpl',
      1 => 1545825029,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '20607334305c236b6e735089-38343745',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c236b6e8c4c32_21386273',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c236b6e8c4c32_21386273')) {function content_5c236b6e8c4c32_21386273($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/function.script.php';
...
if ($_smarty_tpl->tpl_vars['products']->value) {?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['settings']->value['abt__unitheme']['show_sku_in_multicolumns_list']['value']=='Y') {?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['settings']->value['abt__unitheme']['show_qty_in_multicolumns_list']['value']=='Y') {?>
    	<?php $_smarty_tpl->tpl_vars["show_qty"] = new Smarty_variable(true, null, 0);?>
...
if ($_smarty_tpl->tpl_vars['settings']->value['abt__unitheme']['show_sku_in_multicolumns_list']['value']=='Y'&&$_smarty_tpl->tpl_vars['product']->value['product_code']) {?><div class="sku"><?php $_smarty_tpl->tpl_vars["sku"] = new Smarty_variable("sku_".((string)$_smarty_tpl->tpl_vars['obj_id']->value), null, 0);
echo Smarty::$_smarty_vars['capture'][$_smarty_tpl->tpl_vars['sku']->value];?>
</div><?php }?><div class="grid-list-buttons"><?php if (!$_smarty_tpl->tpl_vars['quick_view']->value&&$_smarty_tpl->tpl_vars['settings']->value['Appearance']['enable_quick_view']=='Y') {
...
}?><div class="ty-grid-list__control <?php if ($_smarty_tpl->tpl_vars['addons']->value['call_requests']['buy_now_with_one_click']=="Y") {?>two-buttons<?php }?>"><?php if ($_smarty_tpl->tpl_vars['show_add_to_cart']->value) {?><div class="button-container"><?php if ($_smarty_tpl->tpl_vars['settings']->value['abt__unitheme']['show_qty_in_multicolumns_list']['value']=='Y') {?><div class="grid-list-qty"><?php $_smarty_tpl->tpl_vars["qty"] = new Smarty_variable("qty_".((string)$_smarty_tpl->tpl_vars['obj_id']->value), null, 0);
...
</div><?php }?></div><?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:additional_info")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:additional_info"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();
...
if ($_smarty_tpl->tpl_vars['show_descr']->value) {?><div class="ty-grid-list__ab-description"><?php $_smarty_tpl->tpl_vars["prod_descr"] = new Smarty_variable("prod_descr_".((string)$_smarty_tpl->tpl_vars['obj_id']->value), null, 0);
