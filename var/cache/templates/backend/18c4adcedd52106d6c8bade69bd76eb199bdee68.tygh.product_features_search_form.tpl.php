<?php /* Smarty version Smarty-3.1.21, created on 2018-12-28 01:04:00
         compiled from "/srv/www/esportshop.ru/design/backend/templates/views/product_features/components/product_features_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13829245625c254c50417a59-76882395%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '18c4adcedd52106d6c8bade69bd76eb199bdee68' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/views/product_features/components/product_features_search_form.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '13829245625c254c50417a59-76882395',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c254c50484ea6_39293816',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c254c50484ea6_39293816')) {function content_5c254c50484ea6_39293816($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/modifier.enum.php';
...
:</label>
    <input type="text" name="description" id="fname" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
" size="30" />
</div>
...
?>
                <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_feature']->value['feature_id'], ENT_QUOTES, 'ISO-8859-1');?>
"<?php if ($_smarty_tpl->tpl_vars['group_feature']->value['feature_id']==$_smarty_tpl->tpl_vars['search']->value['parent_id']) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_feature']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</option>
            <?php } ?>
        </select>
    </div>
...
:&nbsp;<?php echo $_smarty_tpl->__("single");?>
                    ...
                    <td><label for="elm_checkbox_multiple" class="checkbox"><input id="elm_checkbox_multiple" type="checkbox" name="feature_types[]" <?php if (smarty_modifier_in_array(smarty_modifier_enum("ProductFeatures::MULTIPLE_CHECKBOX"),$_smarty_tpl->tpl_vars['search']->value['feature_types'])) {?>checked="checked"<?php }?> value="<?php echo htmlspecialchars(smarty_modifier_enum("ProductFeatures::MULTIPLE_CHECKBOX"), ENT_QUOTES, 'ISO-8859-1');?>
"/><?php echo $_smarty_tpl->__("checkbox");?>
...
:&nbsp;<?php echo $_smarty_tpl->__("text");?>
                    ...
                    <td><label for="elm_selectbox_number" class="checkbox"><input id="elm_selectbox_number"  type="checkbox" name="feature_types[]" <?php if (smarty_modifier_in_array(smarty_modifier_enum("ProductFeatures::NUMBER_SELECTBOX"),$_smarty_tpl->tpl_vars['search']->value['feature_types'])) {?>checked="checked"<?php }?> value="<?php echo htmlspecialchars(smarty_modifier_enum("ProductFeatures::NUMBER_SELECTBOX"), ENT_QUOTES, 'ISO-8859-1');?>
"/><?php echo $_smarty_tpl->__("selectbox");?>
:&nbsp;<?php echo $_smarty_tpl->__("number");?>
</label></td>
                </tr>
                <tr>
                <td><label for="elm_selectbox_brand_type" class="checkbox"><input id="elm_selectbox_brand_type"  type="checkbox" name="feature_types[]" <?php if (smarty_modifier_in_array(smarty_modifier_enum("ProductFeatures::EXTENDED"),$_smarty_tpl->tpl_vars['search']->value['feature_types'])) {?>checked="checked"<?php }?> value="<?php echo htmlspecialchars(smarty_modifier_enum("ProductFeatures::EXTENDED"), ENT_QUOTES, 'ISO-8859-1');?>
"/><?php echo $_smarty_tpl->__("selectbox");?>
:&nbsp;<?php echo $_smarty_tpl->__("brand_type");?>
</label></td>
                    <td><label for="elm_others_text" class="checkbox"><input id="elm_others_text"  type="checkbox" name="feature_types[]" <?php if (smarty_modifier_in_array(smarty_modifier_enum("ProductFeatures::TEXT_FIELD"),$_smarty_tpl->tpl_vars['search']->value['feature_types'])) {?>checked="checked"<?php }?> value="<?php echo htmlspecialchars(smarty_modifier_enum("ProductFeatures::TEXT_FIELD"), ENT_QUOTES, 'ISO-8859-1');?>
"/><?php echo $_smarty_tpl->__("others");?>
:&nbsp;<?php echo $_smarty_tpl->__("text");?>
</label></td>
                    <td><label for="elm_others_number" class="checkbox"><input id="elm_others_number"  type="checkbox" name="feature_types[]" <?php if (smarty_modifier_in_array(smarty_modifier_enum("ProductFeatures::NUMBER_FIELD"),$_smarty_tpl->tpl_vars['search']->value['feature_types'])) {?>checked="checked"<?php }?> value="<?php echo htmlspecialchars(smarty_modifier_enum("ProductFeatures::NUMBER_FIELD"), ENT_QUOTES, 'ISO-8859-1');?>
"/><?php echo $_smarty_tpl->__("others");?>
:&nbsp;<?php echo $_smarty_tpl->__("number");?>
</label></td>
