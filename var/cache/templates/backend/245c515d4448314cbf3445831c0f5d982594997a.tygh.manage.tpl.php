<?php /* Smarty version Smarty-3.1.21, created on 2018-12-28 01:03:59
         compiled from "/srv/www/esportshop.ru/design/backend/templates/views/product_features/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17131191645c254c4f4125d6-80343990%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '245c515d4448314cbf3445831c0f5d982594997a' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/views/product_features/manage.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '17131191645c254c4f4125d6-80343990',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c254c4f49eaa0_96299520',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c254c4f49eaa0_96299520')) {function content_5c254c4f49eaa0_96299520($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/function.script.php';
...
$_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['href_edit'] = new Smarty_variable("product_features.update?feature_id=".((string)$_smarty_tpl->tpl_vars['p_feature']->value['feature_id']).$_tmp1, null, 0);?>
                        ...
                        <tr class="cm-row-item cm-row-status-<?php echo htmlspecialchars(strtolower($_smarty_tpl->tpl_vars['p_feature']->value['status']), ENT_QUOTES, 'ISO-8859-1');?>
" data-ct-product_features="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['p_feature']->value['feature_id'], ENT_QUOTES, 'ISO-8859-1');?>
">
                            <td class="left mobile-hide">
                                <input type="checkbox" name="feature_ids[]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['p_feature']->value['feature_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="checkbox cm-item cm-item-status-<?php echo htmlspecialchars(strtolower($_smarty_tpl->tpl_vars['p_feature']->value['status']), ENT_QUOTES, 'ISO-8859-1');?>
" />
                            </td>
...
">
                                <div class="object-group-link-wrap">
                                    <?php if (!$_smarty_tpl->tpl_vars['non_editable']->value) {?>
                                        <a <?php if (!$_smarty_tpl->tpl_vars['show_in_popup']->value) {?>href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['href_edit']->value), ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?> class="row-status cm-external-click <?php if ($_smarty_tpl->tpl_vars['non_editable']->value) {?> no-underline<?php }?>"<?php if (!$_smarty_tpl->tpl_vars['non_editable']->value) {?> data-ca-external-click-id="opener_group<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['p_feature']->value['feature_id'], ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['p_feature']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</a>
                                    <?php } else { ?>
                                        <span class="unedited-element block"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['p_feature']->value['description'])===null||$tmp==='' ? $_smarty_tpl->__("view") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</span>
                                    <?php }?>
                                    <span class="muted"><small> #<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['p_feature']->value['feature_id'], ENT_QUOTES, 'ISO-8859-1');?>
</small></span>
...
">
                                <?php if ($_smarty_tpl->tpl_vars['group_feature']->value) {?>
                                    <div class="object-group-link-wrap cm-row-status-<?php echo htmlspecialchars(strtolower($_smarty_tpl->tpl_vars['group_feature']->value['status']), ENT_QUOTES, 'ISO-8859-1');?>
">
                                        ...
                                        <?php } else { ?>
                                            <span class="unedited-element block"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['group_feature']->value['description'])===null||$tmp==='' ? $_smarty_tpl->__("view") : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</span>
                                        <?php }?>
                                    </div>
                                <?php } else { ?>
