<?php /* Smarty version Smarty-3.1.21, created on 2018-10-19 04:47:00
         compiled from "/opt/lampp/htdocs/cscartRep/design/backend/templates/addons/advanced_import/views/import_presets/components/field.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18461311895bc93794ba1e62-31976777%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2948bd43fa2339391c1f0e9727c2b306e880b13f' => 
    array (
      0 => '/opt/lampp/htdocs/cscartRep/design/backend/templates/addons/advanced_import/views/import_presets/components/field.tpl',
      1 => 1539165548,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '18461311895bc93794ba1e62-31976777',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bc93794c09729_88415214',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bc93794c09729_88415214')) {function content_5bc93794c09729_88415214($_smarty_tpl) {?><?php
...
">
        <input type="hidden"
               name="fields[_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'UTF-8');?>
][name]"
...
"
                id="elm_import_field_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
"
                name="fields[_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'UTF-8');?>
][related_object]"
...
?>
                <optgroup label="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_info']->value['description'], ENT_QUOTES, 'UTF-8');?>
">
...
continue 1;
                        ...
                        <option data-ca-advanced-import-field-related-object-type="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['related_object_type']->value, ENT_QUOTES, 'UTF-8');?>
"
                                value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['object_name']->value, ENT_QUOTES, 'UTF-8');?>
"
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['object']->value['description'], ENT_QUOTES, 'UTF-8');
}
