<?php /* Smarty version Smarty-3.1.21, created on 2018-12-30 01:12:08
         compiled from "/srv/www/esportshop.ru/design/backend/templates/addons/discussion/views/discussion_manager/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3451486965c27f138e67377-30731948%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5642864ae78ab584525caaf21b928965958ed780' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/addons/discussion/views/discussion_manager/manage.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '3451486965c27f138e67377-30731948',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c27f138ead063_09825053',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c27f138ead063_09825053')) {function content_5c27f138ead063_09825053($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/function.script.php';
...
<div id="content_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['discussion_object_types']->value[$_smarty_tpl->tpl_vars['discussion_object_type']->value], ENT_QUOTES, 'ISO-8859-1');?>
">
...
" method="POST" name="update_posts_form_<?php echo htmlspecialchars(strtolower($_smarty_tpl->tpl_vars['discussion_object_type']->value), ENT_QUOTES, 'ISO-8859-1');?>
">
<input type="hidden" name="redirect_url" value="<?php echo htmlspecialchars(fn_url("discussion_manager.manage?selected_section=".((string)$_smarty_tpl->tpl_vars['discussion_object_types']->value[$_smarty_tpl->tpl_vars['discussion_object_type']->value])), ENT_QUOTES, 'ISO-8859-1');?>
">
...
<?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>
    <?php if ($_smarty_tpl->tpl_vars['posts']->value) {?>
        <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
            <li><?php ob_start();
echo htmlspecialchars(strtolower($_smarty_tpl->tpl_vars['discussion_object_type']->value), ENT_QUOTES, 'ISO-8859-1');
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
        ...
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/save.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_name'=>"dispatch[discussion.update]",'but_role'=>"action",'but_target_form'=>"update_posts_form_".((string)strtolower($_smarty_tpl->tpl_vars['discussion_object_type']->value)),'but_meta'=>"cm-submit ".((string)$_smarty_tpl->tpl_vars['but_class']->value)), 0);?>
...
<!--content_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['discussion_object_types']->value[$_smarty_tpl->tpl_vars['discussion_object_type']->value], ENT_QUOTES, 'ISO-8859-1');?>
--></div>
