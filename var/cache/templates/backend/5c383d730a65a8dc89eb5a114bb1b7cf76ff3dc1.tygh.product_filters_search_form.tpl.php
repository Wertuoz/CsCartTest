<?php /* Smarty version Smarty-3.1.21, created on 2018-12-31 01:29:37
         compiled from "/srv/www/esportshop.ru/design/backend/templates/views/product_filters/components/product_filters_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3781579985c2946d184f424-82333558%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5c383d730a65a8dc89eb5a114bb1b7cf76ff3dc1' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/views/product_filters/components/product_filters_search_form.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '3781579985c2946d184f424-82333558',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c2946d1882044_24879083',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c2946d1882044_24879083')) {function content_5c2946d1882044_24879083($_smarty_tpl) {?><?php if (!is_callable('smarty_function_array_to_fields')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/function.array_to_fields.php';
...
" name="product_filters_search_form" method="get" class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_meta']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
:</label>
    <div class="break">
        <input type="text" name="feature_name" id="elm_feature_name" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['feature_name'], ENT_QUOTES, 'ISO-8859-1');?>
...
:</label>
    <div class="break">
        <input type="text" name="filter_name" id="elm_filter_name" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search']->value['filter_name'], ENT_QUOTES, 'ISO-8859-1');?>
" size="30" class="search-input-text" />
    </div>
</div>
