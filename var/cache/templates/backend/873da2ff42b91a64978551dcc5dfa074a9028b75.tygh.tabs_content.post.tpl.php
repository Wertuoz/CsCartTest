<?php /* Smarty version Smarty-3.1.21, created on 2018-12-26 15:12:08
         compiled from "/srv/www/esportshop.ru/design/backend/templates/addons/yml_export/hooks/categories/tabs_content.post.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16430876635c23701851ce60-34355415%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '873da2ff42b91a64978551dcc5dfa074a9028b75' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/addons/yml_export/hooks/categories/tabs_content.post.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '16430876635c23701851ce60-34355415',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c2370185b27a2_60595843',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c2370185b27a2_60595843')) {function content_5c2370185b27a2_60595843($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/function.script.php';
?><?php
...
"/>
            <input id="yml2_offer_type_val" type="hidden" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category_data']->value['yml2_offer_type'], ENT_QUOTES, 'ISO-8859-1');?>
"/>
            <div class="controls">
...
:</label>
            <?php if (!empty($_smarty_tpl->tpl_vars['yml2_parent_model_select']->value)) {?>
                <input id="yml2_parent_model_category" type="hidden" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['yml2_parent_model_select']->value[0], ENT_QUOTES, 'ISO-8859-1');?>
.<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['yml2_parent_model_select']->value[1], ENT_QUOTES, 'ISO-8859-1');?>
"/>
            <?php } else { ?>
                <input id="yml2_parent_model_category" type="hidden" value=""/>
            <?php }?>
            <input id="yml2_model_category" type="hidden" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['yml2_model_category']->value, ENT_QUOTES, 'ISO-8859-1');?>
"/>
...
?>
                            <option value="product.<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                        ...
                        <?php } else { ?>
                            <option value="feature.<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['feature_id'], ENT_QUOTES, 'ISO-8859-1');?>
"<?php if ($_smarty_tpl->tpl_vars['yml2_model_select']->value['type']=='feature'&&$_smarty_tpl->tpl_vars['yml2_model_select']->value['value']==$_smarty_tpl->tpl_vars['feature']->value['feature_id']) {?> selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</option>
                        <?php }?>
                    <?php } ?>
                </select>
...
:</label>
            <div class="controls">
                <input type="text" name="category_data[yml2_model]" size="55" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category_data']->value['yml2_model'], ENT_QUOTES, 'ISO-8859-1');?>
...
:</label>
            <?php if (!empty($_smarty_tpl->tpl_vars['yml2_parent_type_prefix_select']->value)) {?>
                <input id="yml2_parent_type_prefix_select" type="hidden" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['yml2_parent_type_prefix_select']->value[0], ENT_QUOTES, 'ISO-8859-1');?>
.<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['yml2_parent_type_prefix_select']->value[1], ENT_QUOTES, 'ISO-8859-1');?>
"/>
            <?php } else { ?>
...
?>
                        ...
                        <?php } else { ?>
                            <option value="feature.<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['feature_id'], ENT_QUOTES, 'ISO-8859-1');?>
"<?php if ($_smarty_tpl->tpl_vars['yml2_type_prefix_select']->value['type']=='feature'&&$_smarty_tpl->tpl_vars['yml2_type_prefix_select']->value['value']==$_smarty_tpl->tpl_vars['feature']->value['feature_id']) {?> selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</option>
                        <?php }?>
                    <?php } ?>
                </select>
...
:</label>
            <div class="controls">
                <input type="text" name="category_data[yml2_type_prefix]" size="55" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category_data']->value['yml2_type_prefix'], ENT_QUOTES, 'ISO-8859-1');?>
