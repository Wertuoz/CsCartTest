<?php /* Smarty version Smarty-3.1.21, created on 2018-12-26 15:09:33
         compiled from "/srv/www/esportshop.ru/design/backend/templates/views/pages/components/pages_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20114668885c236f7d767f16-82752631%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b394e8088a83b5fa941f911f61347b6fa470e26c' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/views/pages/components/pages_search_form.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '20114668885c236f7d767f16-82752631',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c236f7d7f2121_69957917',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c236f7d7f2121_69957917')) {function content_5c236f7d7f2121_69957917($_smarty_tpl) {?><?php if (!is_callable('smarty_function_array_to_fields')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/function.array_to_fields.php';
...
" name="pages_search_form" method="get" class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_meta']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
?>
        <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['t']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
$_smarty_tpl->tpl_vars["p"]->_loop = true;
 $_smarty_tpl->tpl_vars["t"]->value = $_smarty_tpl->tpl_vars["p"]->key;
?>
    <input type="hidden" name="page_type" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['t']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
    <?php } ?>
<?php }?>
...
$_smarty_tpl->tpl_vars["p"]->_loop = true;
?>
                <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['p']->value['page_id'], ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['search']->value['parent_id']==$_smarty_tpl->tpl_vars['p']->value['page_id']) {?>selected="selected"<?php }?>><?php echo preg_replace('!^!m',str_repeat("&#166;&nbsp;&nbsp;&nbsp;&nbsp;",$_smarty_tpl->tpl_vars['p']->value['level']),smarty_modifier_truncate(htmlspecialchars($_smarty_tpl->tpl_vars['p']->value['page'], ENT_QUOTES, 'ISO-8859-1', true),35,"...",true));?>
</option>
            <?php } ?>
        </select>
    <?php }?>
