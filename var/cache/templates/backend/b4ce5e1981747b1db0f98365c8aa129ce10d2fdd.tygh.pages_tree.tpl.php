<?php /* Smarty version Smarty-3.1.21, created on 2018-12-26 15:09:33
         compiled from "/srv/www/esportshop.ru/design/backend/templates/views/pages/components/pages_tree.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17251476265c236f7d1d5b98-72508203%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b4ce5e1981747b1db0f98365c8aa129ce10d2fdd' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/views/pages/components/pages_tree.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '17251476265c236f7d1d5b98-72508203',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c236f7d299587_78320491',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c236f7d299587_78320491')) {function content_5c236f7d299587_78320491($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/srv/www/esportshop.ru/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
?><?php
...
<?php if ($_smarty_tpl->tpl_vars['parent_id']->value) {?><div <?php if (!$_smarty_tpl->tpl_vars['expand_all']->value) {?>class="hidden"<?php }?> id="page<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['combination_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['parent_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php }?>
...
" id="on_page<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['combination_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-combinations-pages<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['combination_suffix']->value, ENT_QUOTES, 'ISO-8859-1');
if ($_smarty_tpl->tpl_vars['expand_all']->value) {?> hidden<?php }?>" ><span class="icon-caret-right "></span></span>
            <span alt="<?php echo $_smarty_tpl->__("expand_collapse_list");?>
" title="<?php echo $_smarty_tpl->__("expand_collapse_list");?>
" id="off_page<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['combination_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-combinations-pages<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['combination_suffix']->value, ENT_QUOTES, 'ISO-8859-1');
...
<?php }?>
<tr class="cm-row-status-<?php echo htmlspecialchars(strtolower($_smarty_tpl->tpl_vars['page']->value['status']), ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['page']->value['level']>0&&$_smarty_tpl->tpl_vars['search']->value['get_tree']=="multi_level") {?>class="multiple-table-row"<?php }?>>
    <td class="left mobile-hide" width="3%">
        <?php if ($_smarty_tpl->tpl_vars['display']->value=="radio") {?>
        <input type="radio" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['checkbox_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" id="radio_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page_id'], ENT_QUOTES, 'ISO-8859-1');?>
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-item" />
        <?php } else { ?>
        <input type="checkbox" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['checkbox_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
[]" id="checkbox_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page_id'], ENT_QUOTES, 'ISO-8859-1');?>
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-item" />
        <?php }?>
    </td>
...
">
        <input type="text" name="pages_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page_id'], ENT_QUOTES, 'ISO-8859-1');?>
][position]" size="3" maxlength="10" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['position'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-micro input-hidden" />
        <?php if (fn_allowed_for("ULTIMATE")) {?>
            <input type="hidden" name="pages_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page_id'], ENT_QUOTES, 'ISO-8859-1');?>
][company_id]" size="3" maxlength="3" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['company_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="hidden" />
        <?php }?>
    </td>
    <?php }?>
...
">
        <div class="text-over" <?php if ($_smarty_tpl->tpl_vars['search']->value['get_tree']=="multi_level") {?>style="padding-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['direction']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" id="on_page<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['combination_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-combination-pages<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['combination_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
result_ids: 'page<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['combination_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page_id'], ENT_QUOTES, 'ISO-8859-1');?>
...
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page_id'], ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-combination-pages<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['combination_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
 <?php if (!$_smarty_tpl->tpl_vars['expand_all']->value||$_smarty_tpl->tpl_vars['hide_show_all']->value) {?>hidden<?php }?>"><span class="icon-caret-down"></span> </span><?php } elseif ($_smarty_tpl->tpl_vars['search']->value['get_tree']=="multi_level") {?><span style="padding-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['direction']->value, ENT_QUOTES, 'ISO-8859-1');?>
: 14px;">&nbsp;</span><?php }
if (!$_smarty_tpl->tpl_vars['picker']->value) {?><a href="<?php echo htmlspecialchars(fn_url("pages.update?page_id=".((string)$_smarty_tpl->tpl_vars['page']->value['page_id'])."&come_from=".((string)$_smarty_tpl->tpl_vars['_come_from']->value)), ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['page']->value['status']=="N") {?>class="manage-root-item-disabled"<?php }?> id="page_title_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page_id'], ENT_QUOTES, 'ISO-8859-1');?>
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php } else { ?><label class="inline-label" for="radio_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page_id'], ENT_QUOTES, 'ISO-8859-1');?>
" id="page_title_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page_id'], ENT_QUOTES, 'ISO-8859-1');?>
"><?php }
echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page'], ENT_QUOTES, 'ISO-8859-1');
if (!$_smarty_tpl->tpl_vars['picker']->value) {?></a><?php } else { ?></label><?php }
if ($_smarty_tpl->tpl_vars['show_id']->value||$_smarty_tpl->tpl_vars['page']->value['page_type']&&!$_smarty_tpl->tpl_vars['is_exclusive_page_type']->value) {?><span class="muted"> <small><?php if ($_smarty_tpl->tpl_vars['show_id']->value) {?> #<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page_id'], ENT_QUOTES, 'ISO-8859-1');
}
...
">
        <input type="hidden" name="pages_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page_id'], ENT_QUOTES, 'ISO-8859-1');?>
][parent_id]" size="3" maxlength="10" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['parent_id'], ENT_QUOTES, 'ISO-8859-1');?>
" />
...
<?php if ($_smarty_tpl->tpl_vars['parent_id']->value) {?><!--page<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['combination_suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['parent_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></div><?php }?><?php }} ?>
