<?php /* Smarty version Smarty-3.1.21, created on 2018-12-29 15:17:56
         compiled from "/srv/www/esportshop.ru/design/backend/templates/views/pages/components/pages_links_tree.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5815339805c2765f45a5195-47611064%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b8208d826436c01e45cc854cf214ae4820ddae75' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/views/pages/components/pages_links_tree.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '5815339805c2765f45a5195-47611064',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c2765f45d1620_51638633',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c2765f45d1620_51638633')) {function content_5c2765f45d1620_51638633($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_in_array')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/modifier.in_array.php';
?><?php
...
?>
    ...
    <li <?php if ($_smarty_tpl->tpl_vars['page']->value['active']) {?>class="active"<?php }?> <?php if (!$_smarty_tpl->tpl_vars['search']->value['paginate']) {?>style="padding-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['direction']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
" class="cm-combination<?php if (!$_smarty_tpl->tpl_vars['expanded']->value) {?> hidden<?php }?>" ><span class="icon-caret-down"> </span></span><?php }?><a href="<?php echo htmlspecialchars(fn_url("pages.update?page_id=".((string)$_smarty_tpl->tpl_vars['page']->value['page_id'])."&come_from=".((string)$_smarty_tpl->tpl_vars['come_from']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
" <?php if (!$_smarty_tpl->tpl_vars['page']->value['subpages']) {?> style="padding-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['direction']->value, ENT_QUOTES, 'ISO-8859-1');?>
: 14px;"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['page'], ENT_QUOTES, 'ISO-8859-1');?>
</a></div>
    </li>
