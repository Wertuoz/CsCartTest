<?php /* Smarty version Smarty-3.1.21, created on 2018-12-29 15:17:55
         compiled from "/srv/www/esportshop.ru/design/backend/templates/addons/form_builder/hooks/pages/tabs_content.post.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19327982325c2765f3e808c6-20310135%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c92e46629376e8da2ac739bd4f6d325d0b17bf54' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/addons/form_builder/hooks/pages/tabs_content.post.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '19327982325c2765f3e808c6-20310135',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c2765f3ec8356_61386622',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c2765f3ec8356_61386622')) {function content_5c2765f3ec8356_61386622($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_in_array')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/modifier.in_array.php';
...
:</label>
        <div class="controls">
            <select id="form_subject" name="page_data[form][general][<?php echo htmlspecialchars(@constant('FORM_SUBJECT'), ENT_QUOTES, 'ISO-8859-1');?>
]">
...
?>
                        <?php if (smarty_modifier_in_array($_smarty_tpl->tpl_vars['element']->value['element_type'],array(@constant('FORM_INPUT'),@constant('FORM_SELECT')))) {?>
                            ...
                            <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'ISO-8859-1');?>
"<?php if ($_smarty_tpl->tpl_vars['form']->value[@constant('FORM_SUBJECT')]===$_smarty_tpl->tpl_vars['element']->value['element_id']) {?> selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</option>
                        <?php }?>
                    <?php } ?>
                    </optgroup>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
            ...
            <p class="<?php if ($_smarty_tpl->tpl_vars['form']->value[@constant('FORM_SUBJECT')]!=="0") {?>hidden<?php }?>" id="form_subject_text">
                <input type="text" name="page_data[form][general][<?php echo htmlspecialchars(@constant('FORM_SUBJECT_TEXT'), ENT_QUOTES, 'ISO-8859-1');?>
]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form']->value[@constant('FORM_SUBJECT_TEXT')], ENT_QUOTES, 'ISO-8859-1');?>
" />
            </p>
        </div>
...
:</label>
        ...
        <div class="controls">
            <textarea id="form_submit_text" class="cm-wysiwyg input-textarea-long" rows="5" cols="50" name="page_data[form][general][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_submit_const']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" rows="5"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form']->value[$_smarty_tpl->tpl_vars['form_submit_const']->value], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
        </div>
...
:</label>
        ...
        <div class="controls">
            <input id="form_recipient" class="input-text" type="text" name="page_data[form][general][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_recipient_const']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form']->value[$_smarty_tpl->tpl_vars['form_recipient_const']->value], ENT_QUOTES, 'ISO-8859-1');?>
">
        </div>
    </div>
...
:</label>
        ...
        <div class="controls">
                <input type="hidden" name="page_data[form][general][<?php echo htmlspecialchars(@constant('FORM_IS_SECURE'), ENT_QUOTES, 'ISO-8859-1');?>
]" value="N">
                <span class="checkbox">
                    <input type="checkbox" id="form_is_secure" value="Y" <?php if ($_smarty_tpl->tpl_vars['form']->value[$_smarty_tpl->tpl_vars['form_secure_const']->value]=="Y") {?>checked="checked"<?php }?> name="page_data[form][general][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_secure_const']->value, ENT_QUOTES, 'ISO-8859-1');?>
]">
                </span>
        </div>
    </div>
