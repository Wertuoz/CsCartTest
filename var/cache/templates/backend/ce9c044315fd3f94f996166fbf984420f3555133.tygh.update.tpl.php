<?php /* Smarty version Smarty-3.1.21, created on 2018-12-28 01:03:59
         compiled from "/srv/www/esportshop.ru/design/backend/templates/views/product_features/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20819366015c254c4f5b6e01-93981221%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ce9c044315fd3f94f996166fbf984420f3555133' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/views/product_features/update.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '20819366015c254c4f5b6e01-93981221',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c254c4f6c8e10_33203312',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c254c4f6c8e10_33203312')) {function content_5c254c4f6c8e10_33203312($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/function.script.php';
...
" method="post" name="update_features_form_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="form-horizontal form-edit cm-disable-empty-files <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['hide_inputs_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
" enctype="multipart/form-data">
<input type="hidden" class="cm-no-hide-input" name="feature_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
...
" />
<?php }?>
<input type="hidden" class="cm-no-hide-input" name="redirect_url" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['return_url']->value)===null||$tmp==='' ? $_REQUEST['return_url'] : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
" />
...
" class="cm-js <?php if ($_smarty_tpl->tpl_vars['active_tab']->value=="tab_details_".((string)$_smarty_tpl->tpl_vars['id']->value)) {?> active<?php }?>"><a><?php echo $_smarty_tpl->__("general");?>
        ...
        <li id="tab_variants_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-js <?php if ($_smarty_tpl->tpl_vars['feature']->value['feature_type']&&strpos($_smarty_tpl->tpl_vars['selectable_group']->value,$_smarty_tpl->tpl_vars['feature']->value['feature_type'])===false||!$_smarty_tpl->tpl_vars['feature']->value) {?>hidden<?php }?> <?php if ($_smarty_tpl->tpl_vars['active_tab']->value=="tab_variants_".((string)$_smarty_tpl->tpl_vars['id']->value)) {?> active<?php }?>"><a><?php echo $_smarty_tpl->__("variants");?>
        ...
        <li id="tab_categories_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
">
    <fieldset>
        <div class="control-group">
            <label class="control-label cm-required" for="elm_feature_name_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("name");?>
</label>
            <div class="controls">
            <input class="span9" type="text" name="feature_data[description]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
" id="elm_feature_name_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
            </div>
        </div>
        ...
        <div class="control-group">
            <label class="control-label" for="elm_feature_code_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("feature_code");?>
</label>
            <div class="controls">
                <input type="text" size="3" name="feature_data[feature_code]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['feature_code'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-medium" id="elm_feature_code_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
            </div>
        </div>

        <div class="control-group">
            <label class="control-label" for="elm_feature_position_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("position");?>
</label>
            <div class="controls">
                <input type="text" size="3" name="feature_data[position]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['position'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-medium" id="elm_feature_position_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
            </div>
        </div>

        <div class="control-group">
            <label class="control-label" for="elm_feature_description_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("description");?>
</label>
            <div class="controls">
                <textarea name="feature_data[full_description]" cols="55" rows="4" class="cm-wysiwyg input-textarea-long" id="elm_feature_description_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['full_description'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
            </div>
        </div>
        ...
        <?php if ($_smarty_tpl->tpl_vars['is_group']->value||$_smarty_tpl->tpl_vars['feature']->value['feature_type']==smarty_modifier_enum("ProductFeatures::GROUP")) {?>
            <input type="hidden" name="feature_data[feature_type]" value="<?php echo htmlspecialchars(smarty_modifier_enum("ProductFeatures::GROUP"), ENT_QUOTES, 'ISO-8859-1');?>
" />
        <?php } else { ?>
        <div class="control-group">
            <label class="control-label cm-required" for="elm_feature_type_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
echo $_smarty_tpl->__("group");
                ...
                <select name="feature_data[feature_type]" id="elm_feature_type_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-feature-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
">
                        <option value="<?php echo htmlspecialchars(smarty_modifier_enum("ProductFeatures::SINGLE_CHECKBOX"), ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['feature']->value['feature_type']==smarty_modifier_enum("ProductFeatures::SINGLE_CHECKBOX")) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->__("single");?>
                        ...
                        <option value="<?php echo htmlspecialchars(smarty_modifier_enum("ProductFeatures::MULTIPLE_CHECKBOX"), ENT_QUOTES, 'ISO-8859-1');?>
...
">
                        <option value="<?php echo htmlspecialchars(smarty_modifier_enum("ProductFeatures::TEXT_SELECTBOX"), ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['feature']->value['feature_type']==smarty_modifier_enum("ProductFeatures::TEXT_SELECTBOX")) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->__("text");?>
                        ...
                        <option value="<?php echo htmlspecialchars(smarty_modifier_enum("ProductFeatures::NUMBER_SELECTBOX"), ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['feature']->value['feature_type']==smarty_modifier_enum("ProductFeatures::NUMBER_SELECTBOX")) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->__("number");?>
                        ...
                        <option value="<?php echo htmlspecialchars(smarty_modifier_enum("ProductFeatures::EXTENDED"), ENT_QUOTES, 'ISO-8859-1');?>
...
">
                        <option value="<?php echo htmlspecialchars(smarty_modifier_enum("ProductFeatures::TEXT_FIELD"), ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['feature']->value['feature_type']==smarty_modifier_enum("ProductFeatures::TEXT_FIELD")) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->__("text");?>
                        ...
                        <option value="<?php echo htmlspecialchars(smarty_modifier_enum("ProductFeatures::NUMBER_FIELD"), ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['feature']->value['feature_type']==smarty_modifier_enum("ProductFeatures::NUMBER_FIELD")) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->__("number");?>
                        ...
                        <option value="<?php echo htmlspecialchars(smarty_modifier_enum("ProductFeatures::DATE"), ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['feature']->value['feature_type']==smarty_modifier_enum("ProductFeatures::DATE")) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->__("date");?>
                ...
                <div class="error-message feature_type_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" style="display: none" id="warning_feature_change_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><div class="arrow"></div><div class="message"><p><?php echo $_smarty_tpl->__("warning_variants_removal");?>
        ...
        <div class="control-group">
            <label class="control-label" for="elm_feature_group_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("group");?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['feature']->value['feature_type']==smarty_modifier_enum("ProductFeatures::GROUP")) {?>-<?php } else { ?>
                <select name="feature_data[parent_id]" id="elm_feature_group_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-feature-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                        <?php if ($_smarty_tpl->tpl_vars['group_feature']->value['feature_type']==smarty_modifier_enum("ProductFeatures::GROUP")) {?>
                            <option data-ca-display-on-product="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_feature']->value['display_on_product'], ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-display-on-catalog="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_feature']->value['display_on_catalog'], ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-display-on-header="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_feature']->value['display_on_header'], ENT_QUOTES, 'ISO-8859-1');?>
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_feature']->value['feature_id'], ENT_QUOTES, 'ISO-8859-1');?>
"<?php if ($_smarty_tpl->tpl_vars['group_feature']->value['feature_id']==$_smarty_tpl->tpl_vars['feature']->value['parent_id']) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_feature']->value['description'], ENT_QUOTES, 'ISO-8859-1');?>
</option>
                        <?php }?>
                    <?php } ?>
                </select>
        ...
        <div class="control-group">
            <label class="control-label" for="elm_feature_display_on_product_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>$_smarty_tpl->__("tt_views_product_features_update_feature_display_on_product")), 0);?>
            ...
            <input id="elm_feature_display_on_product_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" type="checkbox" name="feature_data[display_on_product]" value="Y" data-ca-display-id="OnProduct" <?php if ($_smarty_tpl->tpl_vars['feature']->value['display_on_product']=="Y") {?>checked="checked"<?php }?> <?php if ($_smarty_tpl->tpl_vars['feature']->value['parent_id']&&$_smarty_tpl->tpl_vars['group_features']->value[$_smarty_tpl->tpl_vars['feature']->value['parent_id']]['display_on_product']=="Y") {?>disabled="disabled"<?php }?>/>
        ...
        <div class="control-group">
            <label class="control-label" for="elm_feature_display_on_catalog_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>$_smarty_tpl->__("tt_views_product_features_update_feature_display_on_catalog")), 0);?>
            ...
            <input id="elm_feature_display_on_catalog_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" type="checkbox" name="feature_data[display_on_catalog]" value="Y"  data-ca-display-id="OnCatalog" <?php if ($_smarty_tpl->tpl_vars['feature']->value['display_on_catalog']=="Y") {?>checked="checked"<?php }?> <?php if ($_smarty_tpl->tpl_vars['feature']->value['parent_id']&&$_smarty_tpl->tpl_vars['group_features']->value[$_smarty_tpl->tpl_vars['feature']->value['parent_id']]['display_on_catalog']=="Y") {?>disabled="disabled"<?php }?> />
        ...
        <div class="control-group">
            <label class="control-label" for="elm_feature_display_on_header_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("feature_display_on_header");?>
</label>
            <div class="controls">
            <input type="hidden" name="feature_data[display_on_header]" value="N" />
            <input id="elm_feature_display_on_header_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" type="checkbox" name="feature_data[display_on_header]" value="Y"  data-ca-display-id="OnHeader" <?php if ($_smarty_tpl->tpl_vars['feature']->value['display_on_header']=="Y") {?>checked="checked"<?php }?> <?php if ($_smarty_tpl->tpl_vars['feature']->value['parent_id']&&$_smarty_tpl->tpl_vars['group_features']->value[$_smarty_tpl->tpl_vars['feature']->value['parent_id']]['display_on_header']=="Y") {?>disabled="disabled"<?php }?> />
        ...
        <div class="control-group">
            <label class="control-label" for="elm_feature_prefix_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>$_smarty_tpl->__("tt_views_product_features_update_prefix")), 0);?>
            ...
            <div class="controls">
            <input type="text" name="feature_data[prefix]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['prefix'], ENT_QUOTES, 'ISO-8859-1');?>
" id="elm_feature_prefix_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
            </div>
        </div>

        <div class="control-group">
            <label class="control-label" for="elm_feature_suffix_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>$_smarty_tpl->__("tt_views_product_features_update_suffix")), 0);?>
            ...
            <div class="controls">
            <input type="text" name="feature_data[suffix]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['suffix'], ENT_QUOTES, 'ISO-8859-1');?>
" id="elm_feature_suffix_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" /></div>
        </div>
        <?php }?>
...
--></div>
    ...
    <div class="hidden" id="content_tab_categories_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
    ...
    <!--content_tab_categories_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></div>
    <?php }?>
    ...
    <div class="hidden" id="content_tab_variants_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
    ...
    <!--content_tab_variants_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></div>
    <?php }?>
