<?php /* Smarty version Smarty-3.1.21, created on 2018-12-29 15:17:55
         compiled from "/srv/www/esportshop.ru/design/backend/templates/views/pages/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9143036155c2765f36669a1-05318826%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd29827d42fe0842eabefeaf2bda25903c4b72cd0' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/views/pages/update.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '9143036155c2765f36669a1-05318826',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c2765f374a1a3_99904652',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c2765f374a1a3_99904652')) {function content_5c2765f374a1a3_99904652($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/block.hook.php';
...
<div id="update_page_form_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page_data']->value['page_id'], ENT_QUOTES, 'ISO-8859-1');?>
">
    <input type="hidden" class="cm-no-hide-input" id="selected_section" name="selected_section" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['selected_section']->value, ENT_QUOTES, 'ISO-8859-1');?>
"/>
    <input type="hidden" class="cm-no-hide-input" id="page_id" name="page_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
    <input type="hidden" class="cm-no-hide-input" name="page_data[page_type]" id="page_type" size="55" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page_type']->value, ENT_QUOTES, 'ISO-8859-1');?>
"/>
    <input type="hidden" class="cm-no-hide-input" name="come_from" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['come_from']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
    <input type="hidden" class="cm-no-hide-input" name="result_ids" value="update_page_form_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page_data']->value['page_id'], ENT_QUOTES, 'ISO-8859-1');?>
"/>
...
:</label>
            <div class="controls">
                <input type="text" name="page_data[page]" id="elm_page_name" size="55" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page_data']->value['page'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-large" />
            </div>
        </div>
...
:</label>
                <div class="controls">
                    <input type="text" name="page_data[page_title]" id="elm_page_title" size="55" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page_data']->value['page_title'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-large" />
                </div>
            </div>
...
:</label>
                <div class="controls">
                    <textarea name="page_data[meta_description]" id="elm_page_meta_descr" cols="55" rows="2" class="input-large"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page_data']->value['meta_description'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
                </div>
            </div>
...
:</label>
                <div class="controls">
                    <textarea name="page_data[meta_keywords]" id="elm_page_meta_keywords" cols="55" rows="2" class="input-large"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page_data']->value['meta_keywords'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
                </div>
            </div>
...
<!--update_page_form_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page_data']->value['page_id'], ENT_QUOTES, 'ISO-8859-1');?>
--></div>
</form>
