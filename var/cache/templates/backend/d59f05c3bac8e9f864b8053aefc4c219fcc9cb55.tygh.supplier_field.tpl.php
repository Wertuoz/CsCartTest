<?php /* Smarty version Smarty-3.1.21, created on 2018-12-30 01:34:24
         compiled from "/srv/www/esportshop.ru/design/backend/templates/addons/suppliers/views/suppliers/components/supplier_field.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12302713555c27f6706a7509-54281819%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd59f05c3bac8e9f864b8053aefc4c219fcc9cb55' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/addons/suppliers/views/suppliers/components/supplier_field.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '12302713555c27f6706a7509-54281819',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c27f6706ce554_32745711',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c27f6706ce554_32745711')) {function content_5c27f6706ce554_32745711($_smarty_tpl) {?><?php
...
" id="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['id']->value)===null||$tmp==='' ? "supplier_id" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['supplier']->value['supplier_id'], ENT_QUOTES, 'ISO-8859-1');?>
" />
        <?php if ($_smarty_tpl->tpl_vars['read_only']->value) {?>
            <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['supplier']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php if (!$_smarty_tpl->tpl_vars['no_wrap']->value) {?>
        <div class="control-group" id="suppliers_selector">
            <label class="control-label" for="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['id']->value)===null||$tmp==='' ? "supplier_id" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
