<?php /* Smarty version Smarty-3.1.21, created on 2018-12-30 01:30:45
         compiled from "/srv/www/esportshop.ru/design/backend/templates/views/tabs/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19835734455c27f595e27963-97700886%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e178e3d025203a148e213640ff0cb12eaf5fe0c6' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/views/tabs/update.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '19835734455c27f595e27963-97700886',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c27f595e8f420_71089597',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c27f595e8f420_71089597')) {function content_5c27f595e8f420_71089597($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/function.script.php';
...
if (!is_callable('smarty_function_include_ext')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/function.include_ext.php';
?><?php
...
var html_id = "<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
";
...
" enctype="multipart/form-data" name="update_product_tab_form_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" method="post" class=" form-horizontal">
<div id="content_group_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
    <input type="hidden" name="tab_data[tab_id]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
    <input type="hidden" name="result_ids" value="content_group_tab_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />

    <div class="tabs cm-j-tabs">
        <ul class="nav nav-tabs">
            <li id="general_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-js<?php if ($_smarty_tpl->tpl_vars['active_tab']->value=="block_general_".((string)$_smarty_tpl->tpl_vars['html_id']->value)) {?> active<?php }?>">
            ...
            <?php if ($_smarty_tpl->tpl_vars['dynamic_object_scheme']->value&&$_smarty_tpl->tpl_vars['id']->value>0) {?>
                <li id="tab_status_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="cm-js<?php if ($_smarty_tpl->tpl_vars['active_tab']->value=="block_status_".((string)$_smarty_tpl->tpl_vars['html_id']->value)) {?> active<?php }?>">
    ...
    <div class="cm-tabs-content" id="tabs_content_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
        <div id="content_general_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
            <fieldset>
                <div class="control-group">
                    <label class="cm-required control-label" for="elm_description_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("name");?>
:</label>
                    <div class="controls">
                        <input type="text" name="tab_data[name]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tab_data']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
" id="elm_description_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="input-text" size="18" />
                ...
                <div class="control-group">
                    <label for="elm_show_in_popup_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="control-label"><?php echo $_smarty_tpl->__("show_tab_in_popup");?>
:</label>
                    <div class="controls">
                        <input type="hidden" name="tab_data[show_in_popup]" value="N" />
                        <input type="checkbox" name="tab_data[show_in_popup]" id="elm_show_in_popup_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" <?php if ($_smarty_tpl->tpl_vars['tab_data']->value['show_in_popup']=="Y") {?>checked="checked"<?php }?> value="Y">
                ...
                <?php if ($_smarty_tpl->tpl_vars['tab_data']->value['is_primary']!=='Y'&&fn_check_view_permissions("block_manager.update_block")) {?>
                    <div class="control-group">
                        <label for="elm_block_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
:</label>
                        <div class="controls clearfix help-inline-wrap">
                            ...
                            <br><br>
                            <div id="ajax_update_block_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
                                <input type="hidden" name="block_data[block_id]" id="elm_block_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['tab_data']->value['block_id'])===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
" />
                                ...
                                <?php }?>
                            <!--ajax_update_block_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></div>
                        </div>
                    </div>
                <?php }?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['dynamic_object_scheme']->value&&$_smarty_tpl->tpl_vars['id']->value>0) {?>
            <div id="content_tab_status_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" >
                <fieldset>
                    <div class="control-group">
...
echo $_smarty_tpl->__("enable_for");
            ...
            <!--content_tab_status_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></div>
        <?php }?>
    </div>

<!--content_group_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['html_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></div>
