<?php /* Smarty version Smarty-3.1.21, created on 2018-12-26 15:04:34
         compiled from "/srv/www/esportshop.ru/design/backend/templates/addons/abt__unitheme/overrides/views/static_data/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21046511865c236e52ddf2d6-97531319%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ea97ed1b1e2e3eb618969c3e159c3aff6d348980' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/addons/abt__unitheme/overrides/views/static_data/update.tpl',
      1 => 1545824810,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '21046511865c236e52ddf2d6-97531319',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c236e52ef9e94_55172746',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c236e52ef9e94_55172746')) {function content_5c236e52ef9e94_55172746($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/block.hook.php';
...
:</label>
<div class="controls">
<input class="cm-abt-ut-colorpicker" style="font-family: monospace;" type="text" name="static_data[ab__ut_mwi__label_color]" id="ab__ut_mwi__label_color_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" value="<?php echo htmlspecialchars((($tmp = @smarty_modifier_replace($_smarty_tpl->tpl_vars['static_data']->value['ab__ut_mwi__label_color'],"transparent",''))===null||$tmp==='' ? "#ffffff" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
"/>
</div>
</div>
...
:</label>
<div class="controls">
<input class="cm-abt-ut-colorpicker" style="font-family: monospace;" type="text" name="static_data[ab__ut_mwi__label_background]" id="ab__ut_mwi__label_background_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" value="<?php echo htmlspecialchars((($tmp = @smarty_modifier_replace($_smarty_tpl->tpl_vars['static_data']->value['ab__ut_mwi__label_background'],"transparent",''))===null||$tmp==='' ? "#ffffff" : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
"/>
</div>
</div>
</fieldset>
