<?php /* Smarty version Smarty-3.1.21, created on 2018-11-30 01:45:05
         compiled from "/srv/www/esportshop.ru/design/backend/templates/common/ajax_select_object.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2488335095c006bf1afc419-44184352%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2679bb1717c6938c47e4360effd5cb2be04e6a40' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/common/ajax_select_object.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2488335095c006bf1afc419-44184352',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c006bf1b36f38_75524953',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c006bf1b36f38_75524953')) {function content_5c006bf1b36f38_75524953($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/modifier.truncate.php';
...
<a <?php if ($_smarty_tpl->tpl_vars['span_wrapping']->value==false) {?>id="sw_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
_wrap_"><?php echo htmlspecialchars(smarty_modifier_truncate($_smarty_tpl->tpl_vars['text']->value,40,"...",true), ENT_QUOTES, 'ISO-8859-1');?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['dropdown_icon']->value) {?><i class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dropdown_icon']->value, ENT_QUOTES, 'ISO-8859-1');?>
 dropdown-menu__icon"></i><?php }?>
        <b class="caret"></b>
    <?php } else { ?>
        <?php echo htmlspecialchars(smarty_modifier_truncate($_smarty_tpl->tpl_vars['text']->value,40,"...",true), ENT_QUOTES, 'ISO-8859-1');?>
...
_ajax_select_object" 
    <?php if ($_smarty_tpl->tpl_vars['extra_data_old_id']->value) {?>data-ca-target-old-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['extra_data_old_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>
    <?php if ($_smarty_tpl->tpl_vars['extra_data_new_id']->value) {?>data-ca-target-new-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['extra_data_new_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>
>
    <li>
...
..." class="span3 input-text cm-ajax-content-input" data-ca-target-id="content_loader_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" size="16">
        </div>
    </li>
    <li>
...
?>
                ...
                <?php }?>
                <li>
                    <a data-ca-action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['value'], ENT_QUOTES, 'ISO-8859-1');?>
