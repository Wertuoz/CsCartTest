<?php /* Smarty version Smarty-3.1.21, created on 2018-11-30 01:45:51
         compiled from "/srv/www/esportshop.ru/design/backend/templates/addons/advanced_import/views/import_presets/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2587873075c006c1f60af36-75119967%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3dd3f2b0e449e86f4c067f341bdb234792c05cb0' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/addons/advanced_import/views/import_presets/update.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2587873075c006c1f60af36-75119967',
  'function' => 
  array (
  ),
  'variables' => 
...
"
              ...
              data-ca-advanced-import-preset-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"
              data-ca-advanced-import-preset-object-type="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['preset']->value['object_type'], ENT_QUOTES, 'ISO-8859-1');?>
"
              data-ca-advanced-import-preset-name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['preset']->value['preset'], ENT_QUOTES, 'ISO-8859-1');?>
"
        >

            <input type="hidden" name="preset_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"/>
            <input type="hidden" name="result_ids" value="content_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
"/>
            <input type="hidden" name="object_type" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['preset']->value['object_type'], ENT_QUOTES, 'ISO-8859-1');?>
"/>
            <?php if ($_smarty_tpl->tpl_vars['start_import']->value) {?>
                <input type="hidden" name="return_url" value="<?php echo htmlspecialchars("import_presets.update&preset_id=".((string)$_smarty_tpl->tpl_vars['id']->value), ENT_QUOTES, 'ISO-8859-1');?>
"/>
            <?php }?>
		    ...
		    <pre><code><?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
<?php $_tmp1=ob_get_clean();?><?php echo htmlspecialchars(fn_get_console_command("php /path/to/cart/",$_smarty_tpl->tpl_vars['config']->value['admin_index'],array("dispatch"=>"advanced_import.import.import","preset_id"=>$_tmp1,"p")), ENT_QUOTES, 'ISO-8859-1');?>
</code></pre>
                <?php }?>
                ...
                <div id="information" class="in collapse">
                    ...
                    <div class="control-group">
                        <input type="hidden"
                               ...
                               name="file_type"
                               value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['preset']->value['file_type'])===null||$tmp==='' ? (smarty_modifier_enum("Addons\\AdvancedImport\\PresetFileTypes::LOCAL")) : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
"
                        />
                        <input type="hidden"
                               name="file"
                               data-ca-advanced-import-element="file"
                               value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['preset']->value['file'])===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
"
                        />
...
:</label>
                    ...
                    <div class="control-group <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['preset']->value['options']['target_node']['control_group_meta'], ENT_QUOTES, 'ISO-8859-1');?>
...
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>$_smarty_tpl->__($_smarty_tpl->tpl_vars['preset']->value['options']['target_node']['description'])), 0);
                        ...
                        <div class="controls">
                            <input class="input-large"
                                   ...
                                   id="target_node"
                                   size="55"
                                   value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['preset']->value['options']['target_node']['selected_value'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['preset']->value['options']['target_node']['default_value'] : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
"
                            />
                        </div>
                    </div>
...
:</label>
                        <div class="controls">
                            <input class="input-large"
                                   ...
                                   id="elm_preset"
                                   size="55"
                                   value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['preset']->value['preset'], ENT_QUOTES, 'ISO-8859-1');?>
"
                            />
                        </div>
                    </div>
...
:</label>
                        <div class="controls">
                            <div class="input-prepend">
                                <span class="add-on" id="advanced_import_images_path_prefix" data-companies-image-directories="<?php echo htmlspecialchars(smarty_modifier_to_json($_smarty_tpl->tpl_vars['images_path']->value['companies_image_directories']), ENT_QUOTES, 'ISO-8859-1');?>
">
                                    <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['images_path']->value['input_prefix'], ENT_QUOTES, 'ISO-8859-1');?>
                                ...
                                <input id="images_path"
                                       ...
                                       value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['images_path']->value['display_value'], ENT_QUOTES, 'ISO-8859-1');?>
"
                                />
                            </div>
...
:</label>
                        <div class="controls" data-ca-advanced-import-element="delimiter_container">
                            ...
                            <?php ob_start();
echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['preset']->value['options']['delimiter'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['auto_delimiter']->value : $tmp), ENT_QUOTES, 'ISO-8859-1');
