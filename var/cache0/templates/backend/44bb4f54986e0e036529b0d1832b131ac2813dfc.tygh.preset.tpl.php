<?php /* Smarty version Smarty-3.1.21, created on 2018-11-30 01:45:44
         compiled from "/srv/www/esportshop.ru/design/backend/templates/addons/advanced_import/views/import_presets/components/preset.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16742050445c006c186aff82-03000302%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '44bb4f54986e0e036529b0d1832b131ac2813dfc' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/addons/advanced_import/views/import_presets/components/preset.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '16742050445c006c186aff82-03000302',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c006c187381d3_67822935',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c006c187381d3_67822935')) {function content_5c006c187381d3_67822935($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/modifier.enum.php';
...
?><?php
fn_preload_lang_vars(array('name','import','import','preview','advanced_import.uploading_file','select_file','upload','advanced_import.previewing_fields_mapping','advanced_import.last_launch','advanced_import.never','advanced_import.last_status','advanced_import.last_status.','text_exim_data_imported','advanced_import.file','error_file_not_found','advanced_import.user_upload','advanced_import.has_modifiers','yes','no','edit','delete'));
?>
<tr class="import-preset" id="preset_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['preset']->value['preset_id'], ENT_QUOTES, 'ISO-8859-1');?>
">
    <td class="left import-preset__checker mobile-hide">
        <input type="checkbox"
               name="preset_ids[]"
               value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['preset']->value['preset_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
...
">
        <a href="<?php echo htmlspecialchars(fn_url("import_presets.update?preset_id=".((string)$_smarty_tpl->tpl_vars['preset']->value['preset_id'])), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['preset']->value['preset'], ENT_QUOTES, 'ISO-8859-1');?>
</a>
    ...
    <td class="import-preset__run">
        <?php if ($_smarty_tpl->tpl_vars['preset']->value['file_type']==smarty_modifier_enum("Addons\\AdvancedImport\\PresetFileTypes::SERVER")&&$_smarty_tpl->tpl_vars['preset']->value['file_path']||$_smarty_tpl->tpl_vars['preset']->value['file_type']==smarty_modifier_enum("Addons\\AdvancedImport\\PresetFileTypes::URL")) {?>
            <a href="<?php echo htmlspecialchars(fn_url("advanced_import.import?preset_id=".((string)$_smarty_tpl->tpl_vars['preset']->value['preset_id'])), ENT_QUOTES, 'ISO-8859-1');?>
"
        ...
        <?php } elseif ($_smarty_tpl->tpl_vars['preset']->value['file_type']==smarty_modifier_enum("Addons\\AdvancedImport\\PresetFileTypes::LOCAL")) {?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['preview_preset_id']->value==$_smarty_tpl->tpl_vars['preset']->value['preset_id']) {?>
                <?php ob_start();
echo htmlspecialchars(fn_url("import_presets.get_fields.import?preset_id=".((string)$_smarty_tpl->tpl_vars['preset']->value['preset_id'])), ENT_QUOTES, 'ISO-8859-1');
...
"
                     id="import_preset_file_upload_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['preset']->value['preset_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
                >
...
:</label>
                        <div class="controls">
                            <?php echo $_smarty_tpl->getSubTemplate ("common/fileuploader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('hide_server'=>true,'var_name'=>"upload[".((string)$_smarty_tpl->tpl_vars['preset']->value['preset_id'])."]",'prefix'=>$_smarty_tpl->tpl_vars['preset']->value['preset_id'],'allowed_ext'=>"csv, xml"), 0);?>
                ...
                <!--import_preset_file_upload_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['preset']->value['preset_id'], ENT_QUOTES, 'ISO-8859-1');?>
--></div>
...
"
                     id="import_preset_fields_mapping_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['preset']->value['preset_id'], ENT_QUOTES, 'ISO-8859-1');?>
"
                >
                <!--import_preset_fields_mapping_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['preset']->value['preset_id'], ENT_QUOTES, 'ISO-8859-1');?>
--></div>
...
">
        <?php if ($_smarty_tpl->tpl_vars['preset']->value['last_launch']) {?>
            <?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['preset']->value['last_launch'],((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['date_format']).", ".((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['time_format'])), ENT_QUOTES, 'ISO-8859-1');?>
...
">
        <span class="status--<?php echo htmlspecialchars(strtolower($_smarty_tpl->tpl_vars['preset']->value['last_status']), ENT_QUOTES, 'ISO-8859-1');?>
">
...
">
        <?php if ($_smarty_tpl->tpl_vars['preset']->value['file_type']==smarty_modifier_enum("Addons\\AdvancedImport\\PresetFileTypes::URL")) {?>
            <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['preset']->value['file'], ENT_QUOTES, 'ISO-8859-1');?>
" target="_blank"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['preset']->value['file'], ENT_QUOTES, 'ISO-8859-1');?>
</a>
...
<!--preset_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['preset']->value['preset_id'], ENT_QUOTES, 'ISO-8859-1');?>
--></tr><?php }} ?>
