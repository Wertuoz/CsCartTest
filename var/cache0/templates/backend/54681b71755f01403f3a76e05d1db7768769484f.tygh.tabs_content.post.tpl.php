<?php /* Smarty version Smarty-3.1.21, created on 2018-11-30 01:48:17
         compiled from "/srv/www/esportshop.ru/design/backend/templates/addons/yml_export/hooks/products/tabs_content.post.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13793293665c006cb1df2d55-29273742%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '54681b71755f01403f3a76e05d1db7768769484f' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/addons/yml_export/hooks/products/tabs_content.post.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '13793293665c006cb1df2d55-29273742',
  'function' => 
  array (
  ),
  'variables' => 
...
:</label>
            <input id="yml2_parent_offer_val" type="hidden" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['offer_type_parent_category']->value, ENT_QUOTES, 'ISO-8859-1');?>
"/>
            <input id="yml2_offer_type_val" type="hidden" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_offer_type'], ENT_QUOTES, 'ISO-8859-1');?>
"/>
            <div class="controls">
...
?>
                        <option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['offer_type']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                    <label class="checkbox inline" for="elm_yml_exclude_product_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['price']->value['param_id'], ENT_QUOTES, 'ISO-8859-1');?>
">
                        <input type="checkbox" name="product_data[yml2_exclude_price_ids][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['price']->value['param_id'], ENT_QUOTES, 'ISO-8859-1');?>
]" id="elm_yml_exclude_product_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['price']->value['param_id'], ENT_QUOTES, 'ISO-8859-1');?>
" <?php if (smarty_modifier_in_array($_smarty_tpl->tpl_vars['price']->value['param_id'],$_smarty_tpl->tpl_vars['yml2_exclude_prices']->value)) {?>checked="checked"<?php }?> value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['price']->value['param_id'], ENT_QUOTES, 'ISO-8859-1');?>
" />
...
:</label>
            <div class="controls">
                <input type="text" name="product_data[yml2_brand]" id="yml2_brand" size="55" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_brand'], ENT_QUOTES, 'ISO-8859-1');?>
...
:</label>
            <div class="controls">
                <textarea id="elm_yml_product_descr" name="product_data[yml2_description]" cols="55" rows="4" class="input-large"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_description'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
            </div>
        </div>
...
:</label>
            <div class="controls">
                <input type="text" name="product_data[yml2_model]" id="yml2_model" size="55" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_model'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-text-large" <?php if ((!empty($_smarty_tpl->tpl_vars['yml2_model_category']->value))) {?>placeholder="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['yml2_model_category']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>/>
            </div>
        </div>
...
:</label>
            <div class="controls">
                <input type="text" name="product_data[yml2_type_prefix]" id="yml2_type_prefix" size="55" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_type_prefix'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-text-large"  <?php if ((!empty($_smarty_tpl->tpl_vars['yml2_type_prefix_category']->value))) {?>placeholder="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['yml2_type_prefix_category']->value, ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>/>
            </div>
        </div>
...
:</label>
            <div class="controls">
                <input type="text" name="product_data[yml2_sales_notes]" id="yml2_sales_notes" size="50" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_sales_notes'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-text-large" />
            </div>
        </div>
...
:</label>
            <div class="controls">
                <input type="text" name="product_data[yml2_origin_country]" id="yml2_country" size="55" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_origin_country'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-text-large" />
            </div>
        </div>
...
:</label>
            <div class="controls">
                <input type="text" name="product_data[yml2_expiry]" id="yml2_expiry" size="55" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_expiry'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-text-large" />
            </div>
        </div>
...
:</label>
            <div class="controls">
                <input type="text" name="product_data[yml2_bid]" id="yml2_bid" size="10" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_bid'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-small" />
            </div>
        </div>
...
:</label>
            <div class="controls">
                <input type="text" name="product_data[yml2_cbid]" id="yml2_cbid" size="10" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_cbid'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-small" />
            </div>
        </div>
...
:</label>
            <div class="controls">
                <input type="text" name="product_data[yml2_fee]" id="yml2_fee" size="10" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_fee'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-small" />
            </div>
        </div>
...
:</label>
            <div class="controls">
                <input type="text" name="product_data[yml2_purchase_price]" id="yml2_purchase_price" size="10" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_purchase_price'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-small" />
            </div>
        </div>
