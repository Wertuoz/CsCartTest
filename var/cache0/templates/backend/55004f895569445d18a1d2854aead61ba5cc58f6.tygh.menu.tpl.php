<?php /* Smarty version Smarty-3.1.21, created on 2018-11-26 10:09:41
         compiled from "/srv/www/esportshop.ru/design/backend/templates/menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20837881165bfb9c359953d9-63557427%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '55004f895569445d18a1d2854aead61ba5cc58f6' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/menu.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '20837881165bfb9c359953d9-63557427',
  'function' => 
  array (
    'menu_attrs' => 
    array (
  ...
  'unifunc' => 'content_5bfb9c35baa214_50994295',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bfb9c35baa214_50994295')) {function content_5bfb9c35baa214_50994295($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/modifier.enum.php';
        ...
        <?php if (fn_allowed_for("ULTIMATE")) {?>
            ...
            <div class="nav-ult">
                ...
                <?php if ($_smarty_tpl->tpl_vars['runtime']->value['company_data']['storefront']) {?>
                    <a href="<?php echo htmlspecialchars(fn_url(fn_link_attach("?company_id=".((string)$_smarty_tpl->tpl_vars['runtime']->value['company_data']['company_id']),$_smarty_tpl->tpl_vars['store_access_key']->value),"C"), ENT_QUOTES, 'ISO-8859-1');?>
        ...
        <?php if (fn_allowed_for("MULTIVENDOR")&&!$_smarty_tpl->tpl_vars['runtime']->value['simple_ultimate']) {?>
            ...
            <ul class="nav">
                <li class="nav-company">
                    ...
                    <?php }?>
                    <a href="<?php echo htmlspecialchars(htmlspecialchars($_smarty_tpl->tpl_vars['storefront_url']->value, ENT_QUOTES, 'ISO-8859-1', true), ENT_QUOTES, 'ISO-8859-1');?>
" target="_blank" class="brand" title="<?php echo $_smarty_tpl->__("view_storefront");?>
">
                        <i class="icon-shopping-cart icon-white"></i>
                    </a>
...
" class="brand company-name"><?php echo htmlspecialchars(smarty_modifier_truncate($_smarty_tpl->tpl_vars['settings']->value['Company']['company_name'],60,"...",true), ENT_QUOTES, 'ISO-8859-1');?>
                    ...
                    <a href="<?php echo htmlspecialchars(fn_url("settings.manage?section_id=General&highlight=store_mode,store_access_key"), ENT_QUOTES, 'ISO-8859-1');?>
" class="brand">
...
...</a></li>
            ...
            <?php if ($_smarty_tpl->tpl_vars['runtime']->value['company_data']['storefront']) {?>
                <li class="dropdown">
                    <a  href="<?php echo htmlspecialchars(fn_link_attach(fn_url("?company_id=".((string)$_smarty_tpl->tpl_vars['runtime']->value['company_data']['company_id']),"C"),$_smarty_tpl->tpl_vars['store_access_key']->value), ENT_QUOTES, 'ISO-8859-1');?>
"
                        target="_blank"
...
"
            ...
            <?php } else { ?>
                <?php if (fn_allowed_for("MULTIVENDOR")) {?>
                    <li class="dropdown">
                        <a  href="<?php echo htmlspecialchars(fn_link_attach(fn_url('',"C"),$_smarty_tpl->tpl_vars['store_access_key']->value), ENT_QUOTES, 'ISO-8859-1');?>
"
                            target="_blank"
                            title="<?php echo $_smarty_tpl->__("view_storefront");?>
"
