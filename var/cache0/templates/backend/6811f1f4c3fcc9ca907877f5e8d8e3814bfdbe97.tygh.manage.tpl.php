<?php /* Smarty version Smarty-3.1.21, created on 2018-11-30 01:45:03
         compiled from "/srv/www/esportshop.ru/design/backend/templates/views/products/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3861456625c006bef9da544-63769308%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6811f1f4c3fcc9ca907877f5e8d8e3814bfdbe97' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/views/products/manage.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '3861456625c006bef9da544-63769308',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c006befafca27_24780226',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c006befafca27_24780226')) {function content_5c006befafca27_24780226($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/block.hook.php';
...
?><?php
fn_preload_lang_vars(array('position_short','name','sku','price','list_price','purchased_qty','subtotal_sum','quantity','status','name','price','list_price','purchased_qty','subtotal_sum','quantity','edit','edit','delete','status','no_data','text_select_fields2edit_note','modify_selected','global_update','bulk_product_addition','product_subscriptions','add_product','select_fields_to_edit','products'));
?>
...
" class="checkbox cm-item cm-item-status-<?php echo htmlspecialchars(strtolower($_smarty_tpl->tpl_vars['product']->value['status']), ENT_QUOTES, 'ISO-8859-1');?>
 hide" /></td>
            <?php if ($_smarty_tpl->tpl_vars['search']->value['cid']&&$_smarty_tpl->tpl_vars['search']->value['subcats']!="Y") {?>
...
">
                <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:list_list_quantity")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:list_list_quantity"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
" class="input-mini input-hidden" /></td>
                <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"products:list_list_quantity"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
