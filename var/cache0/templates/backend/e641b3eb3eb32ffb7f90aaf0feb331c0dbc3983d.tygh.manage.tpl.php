<?php /* Smarty version Smarty-3.1.21, created on 2018-11-30 01:45:44
         compiled from "/srv/www/esportshop.ru/design/backend/templates/addons/advanced_import/views/import_presets/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15126304435c006c18621db1-01734426%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e641b3eb3eb32ffb7f90aaf0feb331c0dbc3983d' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/addons/advanced_import/views/import_presets/manage.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '15126304435c006c18621db1-01734426',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c006c1867af01_94371795',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c006c1867af01_94371795')) {function content_5c006c1867af01_94371795($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/block.hook.php';
?><?php
fn_preload_lang_vars(array('name','advanced_import.last_launch','advanced_import.last_status','advanced_import.file','advanced_import.has_modifiers','no_data','advanced_import.add_preset','advanced_import.import_'));
?>
            ...
            <div class="table-responsive-wrapper">
                <table width="100%" class="table table-middle table-responsive">
                    ...
                    <tr>
                        ...
                        <th class="import-preset__preset"><a class="cm-ajax" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=name&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'ISO-8859-1');?>
...
echo $_smarty_tpl->tpl_vars['c_dummy']->value;
                        ...
                        <th class="import-preset__last-launch"><a class="cm-ajax" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=last_import&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-target-id=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rev']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
echo $_smarty_tpl->tpl_vars['c_dummy']->value;
                        ...
                        <th class="import-preset__last-status"><a class="cm-ajax" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=status&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'ISO-8859-1');?>
" data-ca-target-id=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rev']->value, ENT_QUOTES, 'ISO-8859-1');?>
