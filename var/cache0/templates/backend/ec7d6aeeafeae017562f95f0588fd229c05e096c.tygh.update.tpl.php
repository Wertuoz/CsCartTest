<?php /* Smarty version Smarty-3.1.21, created on 2018-11-26 12:40:00
         compiled from "/srv/www/esportshop.ru/design/backend/templates/views/companies/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13970710955bfbbf70044897-22962528%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ec7d6aeeafeae017562f95f0588fd229c05e096c' => 
    array (
      0 => '/srv/www/esportshop.ru/design/backend/templates/views/companies/update.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '13970710955bfbbf70044897-22962528',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bfbbf7019d771_79275040',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bfbbf7019d771_79275040')) {function content_5bfbbf7019d771_79275040($_smarty_tpl) {?><?php if (!is_callable('smarty_function_split')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/function.split.php';
if (!is_callable('smarty_block_hook')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_puny_decode')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/modifier.puny_decode.php';
...
?><?php
fn_preload_lang_vars(array('use_existing_store','store','none','recommended','information','vendor_name','storefront_url','ttc_storefront_url','secure_storefront_url','stores_status','ttc_stores_status','storefront_status_access_key_hint','design','store_theme','goto_theme_configuration','status','active','pending','new','disabled','language','create_administrator_account','settings','company','description','redirect_customer_from_storefront','entry_page','none','index','all_pages','countries','shipping_methods','available_for_vendor','shipping_methods','disabled','available_for_vendor','no_data','menu','view_vendor_products','view_vendor_categories','view_vendor_users','view_vendor_orders','vendors_statistics','balance','orders','sales','income','products','delete','editing_vendor','new_vendor'));
?>
...
<form class="form-horizontal form-edit <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_class']->value, ENT_QUOTES, 'ISO-8859-1');?>
 <?php if (!fn_check_view_permissions("companies.update","POST")) {?>cm-hide-inputs<?php }?> <?php if (!$_smarty_tpl->tpl_vars['id']->value) {?>cm-ajax cm-comet cm-disable-check-changes<?php }?>" action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
...
" />
<input type="hidden" name="company_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
                            ...
                            <li>
                                <?php if ($_smarty_tpl->tpl_vars['object_data']->value) {?>
                                    ...
                                    <label class="checkbox">
                                        ...
                                        <input type="checkbox" name="company_data[clone][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['object']->value, ENT_QUOTES, 'ISO-8859-1');?>
]" <?php if ($_smarty_tpl->tpl_vars['object_data']->value['checked_by_default']) {?>checked="checked"<?php }?> class="cm-item-s cm-dependence-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['object']->value, ENT_QUOTES, 'ISO-8859-1');?>
" value="Y" <?php if ($_smarty_tpl->tpl_vars['object_data']->value['dependence']) {?>onchange="fn_check_dependence('<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['object_data']->value['dependence'], ENT_QUOTES, 'ISO-8859-1');?>
', this.checked)"<?php }?> />
...
:</label>
    <div class="controls">
        <input type="text" name="company_data[company]" id="elm_company_name" size="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['company'], ENT_QUOTES, 'ISO-8859-1');?>
" class="input-large" />
    </div>
</div>
...
:</label>
    ...
    <?php if ($_smarty_tpl->tpl_vars['runtime']->value['company_id']) {?>
        http://<?php echo htmlspecialchars(smarty_modifier_puny_decode($_smarty_tpl->tpl_vars['company_data']->value['storefront']), ENT_QUOTES, 'ISO-8859-1');?>

    <?php } else { ?>
        <input type="text" name="company_data[storefront]" id="elm_company_storefront" size="32" value="<?php echo htmlspecialchars(smarty_modifier_puny_decode($_smarty_tpl->tpl_vars['company_data']->value['storefront']), ENT_QUOTES, 'ISO-8859-1');?>
...
:</label>
    <div class="controls">
    <?php if ($_smarty_tpl->tpl_vars['runtime']->value['company_id']) {?>
        https://<?php echo htmlspecialchars(smarty_modifier_puny_decode($_smarty_tpl->tpl_vars['company_data']->value['secure_storefront']), ENT_QUOTES, 'ISO-8859-1');?>

    <?php } else { ?>
        <input type="text" name="company_data[secure_storefront]" id="elm_company_secure_storefront" size="32" value="<?php echo htmlspecialchars(smarty_modifier_puny_decode($_smarty_tpl->tpl_vars['company_data']->value['secure_storefront']), ENT_QUOTES, 'ISO-8859-1');?>
...
<div class="control-group">
    <label class="control-label" for="elm_company_stores_status"><?php echo $_smarty_tpl->__("stores_status");
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>$_smarty_tpl->__("ttc_stores_status")), 0);?>
:</label>
    <div class="controls">
        <?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/company_status_switcher.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('company'=>$_smarty_tpl->tpl_vars['company_data']->value), 0);?>

        <p><?php echo $_smarty_tpl->__("storefront_status_access_key_hint",array("[url]"=>fn_url("settings.manage?switch_company_id=".((string)$_smarty_tpl->tpl_vars['id']->value)."&section_id=General&highlight=store_access_key")));?>
</p>
    </div>
</div>
...
:</label>
    <div class="controls">
        <p><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_info']->value['title'], ENT_QUOTES, 'ISO-8859-1');?>
: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['current_style']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</p>
        <a href="<?php echo htmlspecialchars(fn_url("themes.manage?switch_company_id=".((string)$_smarty_tpl->tpl_vars['id']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
" <?php if ($_smarty_tpl->tpl_vars['lang_code']->value==$_smarty_tpl->tpl_vars['company_data']->value['lang_code']) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['name'], ENT_QUOTES, 'ISO-8859-1');?>
</option>
            <?php } ?>
        </select>
        </div>
...
:</label>
    <div class="controls">
        <textarea id="elm_company_description" name="company_data[company_description]" cols="55" rows="8" class="cm-wysiwyg input-large"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['company_description'], ENT_QUOTES, 'ISO-8859-1');?>
</textarea>
    </div>
</div>
...
"><a href="<?php echo htmlspecialchars(fn_url("shippings.update?shipping_id=".((string)$_smarty_tpl->tpl_vars['shipping_id']->value)), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['shipping'], ENT_QUOTES, 'ISO-8859-1');
if ($_smarty_tpl->tpl_vars['shipping']->value['status']=="D") {?> (<?php echo strtolower($_smarty_tpl->__("disabled"));?>
)<?php }?></a></td>
...
<div class="sidebar-row">
    ...
    <ul class="nav nav-list">
        ...
        <li><a href="<?php echo htmlspecialchars(fn_url("products.manage?company_id=".((string)$_smarty_tpl->tpl_vars['id']->value)), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("view_vendor_products");?>
</a></li>
        <?php if (fn_allowed_for("ULTIMATE")&&$_smarty_tpl->tpl_vars['runtime']->value['company_id']) {?>
            <li><a href="<?php echo htmlspecialchars(fn_url("categories.manage?company_id=".((string)$_smarty_tpl->tpl_vars['id']->value)), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("view_vendor_categories");?>
</a></li>
        <?php }?>
        <li><a href="<?php echo htmlspecialchars(fn_url("profiles.manage?company_id=".((string)$_smarty_tpl->tpl_vars['id']->value)), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("view_vendor_users");?>
</a></li>
        <li><a href="<?php echo htmlspecialchars(fn_url("orders.manage?company_id=".((string)$_smarty_tpl->tpl_vars['id']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
<div class="sidebar-row sidebar-vendor-statistics">
    ...
    <ul class="unstyled">
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"companies:accounting_sidebar_links")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"companies:accounting_sidebar_links"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
            ...
            <li class="vendor-statistics"><a href="<?php echo htmlspecialchars(fn_url("companies.balance?vendor=".((string)$_smarty_tpl->tpl_vars['id']->value)."&selected_section=withdrawals"), ENT_QUOTES, 'ISO-8859-1');?>
...
</a><span><?php echo $_smarty_tpl->__("balance");?>
</span></li>
            <li class="vendor-statistics"><a href="<?php echo htmlspecialchars(fn_url("orders.manage?company_id=".((string)$_smarty_tpl->tpl_vars['id']->value)), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['orders_count'], ENT_QUOTES, 'ISO-8859-1');?>
</a><span><?php echo $_smarty_tpl->__("orders");?>
</span></li>
            <li class="vendor-statistics"><a href="<?php echo htmlspecialchars(fn_url("orders.manage?company_id=".((string)$_smarty_tpl->tpl_vars['id']->value)."&is_search=Y&period=C&time_from=".((string)$_smarty_tpl->tpl_vars['time_from']->value)."&time_to=".((string)$_smarty_tpl->tpl_vars['time_to']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
</a><span><?php echo $_smarty_tpl->__("sales");?>
</span></li>
            <li class="vendor-statistics"><a href="<?php echo htmlspecialchars(fn_url("companies.balance?vendor=".((string)$_smarty_tpl->tpl_vars['id']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
</a><span><?php echo $_smarty_tpl->__("income");?>
</span></li>
            <li class="vendor-statistics"><a href="<?php echo htmlspecialchars(fn_url("products.manage?company_id=".((string)$_smarty_tpl->tpl_vars['id']->value)."&selected_section=withdrawals"), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['products_count'], ENT_QUOTES, 'ISO-8859-1');?>
</a><span><?php echo $_smarty_tpl->__("products");?>
</span></li>
