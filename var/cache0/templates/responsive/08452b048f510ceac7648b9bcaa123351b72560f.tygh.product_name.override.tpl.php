<?php /* Smarty version Smarty-3.1.21, created on 2018-11-26 12:42:34
         compiled from "/srv/www/esportshop.ru/design/themes/responsive/templates/addons/product_variations/hooks/products/product_name.override.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16337604605bfbc00acc0f89-42040251%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '08452b048f510ceac7648b9bcaa123351b72560f' => 
    array (
      0 => '/srv/www/esportshop.ru/design/themes/responsive/templates/addons/product_variations/hooks/products/product_name.override.tpl',
      1 => 1543002778,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '16337604605bfbc00acc0f89-42040251',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bfbc00ad14e19_20410976',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bfbc00ad14e19_20410976')) {function content_5bfbc00ad14e19_20410976($_smarty_tpl) {?><?php if (!is_callable('smarty_function_live_edit')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/function.live_edit.php';
...
" id="name_update_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'ISO-8859-1');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
        <?php if ($_smarty_tpl->tpl_vars['show_name']->value) {?>
            <input type="hidden" name="appearance[show_name]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['show_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
            <?php if ($_smarty_tpl->tpl_vars['hide_links']->value) {?><strong><?php } else { ?><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_link']->value, ENT_QUOTES, 'ISO-8859-1');?>
...
if ($_smarty_tpl->tpl_vars['hide_links']->value) {?></strong><?php } else { ?></a><?php }?>
        <?php } elseif ($_smarty_tpl->tpl_vars['show_trunc_name']->value) {?>
            <input type="hidden" name="appearance[show_trunc_name]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['show_trunc_name']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
            <?php if ($_smarty_tpl->tpl_vars['hide_links']->value) {?><strong><?php } else { ?><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_link']->value, ENT_QUOTES, 'ISO-8859-1');?>
" class="product-title" title="<?php echo htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['product']->value['product']), ENT_QUOTES, 'ISO-8859-1');?>
" <?php echo smarty_function_live_edit(array('name'=>"product:product:".((string)$_smarty_tpl->tpl_vars['product']->value['product_id']),'phrase'=>$_smarty_tpl->tpl_vars['product']->value['product']),$_smarty_tpl);?>
...
if ($_smarty_tpl->tpl_vars['hide_links']->value) {?></strong><?php } else { ?></a><?php }?>
        <?php }?>
    <!--name_update_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'ISO-8859-1');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'ISO-8859-1');?>
--></span>
<?php }?>
