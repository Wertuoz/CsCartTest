<?php /* Smarty version Smarty-3.1.21, created on 2018-11-28 12:01:39
         compiled from "/srv/www/esportshop.ru/design/themes/responsive/templates/views/profiles/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6978547565bfe597378aef3-45167577%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2d9d0db003971d1c73d81688cdc2cf72e4cf524e' => 
    array (
      0 => '/srv/www/esportshop.ru/design/themes/responsive/templates/views/profiles/update.tpl',
      1 => 1543002778,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '6978547565bfe597378aef3-45167577',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bfe59738bb768_61207789',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bfe59738bb768_61207789')) {function content_5bfe59738bb768_61207789($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/block.hook.php';
...
<?php if ($_smarty_tpl->tpl_vars['runtime']->value['mode']=="add"&&$_smarty_tpl->tpl_vars['settings']->value['General']['quick_registration']=="Y") {?>
    <div class="ty-account">
        ...
        <form name="profiles_register_form" action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
" method="post">
...
<?php } else { ?>
    ...
    <?php $_smarty_tpl->_capture_stack[0][] = array("tabsbox", null, null); ob_start(); ?>
        <div class="ty-profile-field ty-account form-wrap" id="content_general">
            <form name="profile_form" action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
" method="post">
