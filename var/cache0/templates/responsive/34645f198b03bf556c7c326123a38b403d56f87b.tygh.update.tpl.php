<?php /* Smarty version Smarty-3.1.21, created on 2018-11-28 11:59:58
         compiled from "/srv/www/esportshop.ru/design/themes/responsive/templates/addons/gift_certificates/views/gift_certificates/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12651278495bfe590e5b2fa4-11687016%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '34645f198b03bf556c7c326123a38b403d56f87b' => 
    array (
      0 => '/srv/www/esportshop.ru/design/themes/responsive/templates/addons/gift_certificates/views/gift_certificates/update.tpl',
      1 => 1543002777,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '12651278495bfe590e5b2fa4-11687016',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bfe590e70fd41_53996321',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bfe590e70fd41_53996321')) {function content_5bfe590e70fd41_53996321($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_format_price')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/modifier.format_price.php';
if (!is_callable('smarty_modifier_sizeof')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/modifier.sizeof.php';
...
<div class="ty-gift-certificate" id="gift_certificate_<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['gift_cert_id']->value)===null||$tmp==='' ? 0 : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
">
...
<div class="ty-control-group">
    ...
    <input type="text" id="gift_cert_recipient" name="gift_cert_data[recipient]" class="ty-input-text-full cm-focus" size="50" maxlength="255" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift_cert_data']->value['recipient'], ENT_QUOTES, 'ISO-8859-1');?>
" />
</div>
...
echo $_smarty_tpl->tpl_vars['base_currency']->value['thousands_separator'];
        ...
        data-m-dec="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['base_currency']->value['decimals'], ENT_QUOTES, 'ISO-8859-1');?>
"
        <?php if ($_smarty_tpl->tpl_vars['base_currency']->value['decimals_separator']) {?> data-a-dec="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['base_currency']->value['decimals_separator'], ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?>
        size="5"
        value="<?php if ($_smarty_tpl->tpl_vars['gift_cert_data']->value) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['gift_cert_data']->value['amount'], ENT_QUOTES, 'ISO-8859-1');
} else {
echo htmlspecialchars($_smarty_tpl->tpl_vars['addons']->value['gift_certificates']['min_amount'], ENT_QUOTES, 'ISO-8859-1');
}?>" />
...
<div class="ty-gift-certificate__switch clearfix">
    ...
    <div class="ty-gift-certificate__switch-mail">
        <input type="hidden" id="send_via" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift_cert_data']->value['send_via'], ENT_QUOTES, 'ISO-8859-1');?>
" />
...
" disabled="disabled"  />
        ...
        <div class="ty-control-group ty-billing-zip-code">
            ...
            <input type="text" id="gift_cert_zipcode" name="gift_cert_data[zipcode]" class="ty-input-text-full" size="50" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift_cert_data']->value['zipcode'], ENT_QUOTES, 'ISO-8859-1');?>
" />
        </div>
...
<!--gift_certificate_<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['gift_cert_id']->value)===null||$tmp==='' ? 0 : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
--></div>
