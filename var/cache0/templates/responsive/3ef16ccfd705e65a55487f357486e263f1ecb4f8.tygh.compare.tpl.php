<?php /* Smarty version Smarty-3.1.21, created on 2018-11-28 12:00:43
         compiled from "/srv/www/esportshop.ru/design/themes/responsive/templates/views/product_features/compare.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15865889185bfe593be2a232-57118391%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3ef16ccfd705e65a55487f357486e263f1ecb4f8' => 
    array (
      0 => '/srv/www/esportshop.ru/design/themes/responsive/templates/views/product_features/compare.tpl',
      1 => 1543002778,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '15865889185bfe593be2a232-57118391',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bfe593c01c8e3_85092343',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bfe593c01c8e3_85092343')) {function content_5bfe593c01c8e3_85092343($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/srv/www/esportshop.ru/app/functions/smarty_plugins/function.script.php';
                ...
                <tr>
                    <td class="ty-compare-products__menu">
                        <ul class="ty-compare-menu">
                            <li class="ty-compare-menu__item"><?php if ($_smarty_tpl->tpl_vars['action']->value!="show_all") {?><a class="ty-compare-menu__a" href="<?php echo htmlspecialchars(fn_url("product_features.compare.show_all"), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("all_features");?>
</a><?php } else { ?><span class="ty-compare-menu__elem"><?php echo $_smarty_tpl->__("all_features");?>
</span><?php }?></li>
                            <li class="ty-compare-menu__item"><?php if ($_smarty_tpl->tpl_vars['action']->value!="similar_only") {?><a class="ty-compare-menu__a" href="<?php echo htmlspecialchars(fn_url("product_features.compare.similar_only"), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->__("similar_only");?>
</a><?php } else { ?><span class="ty-compare-menu__elem"><?php echo $_smarty_tpl->__("similar_only");?>
</span><?php }?></li>
                            <li class="ty-compare-menu__item"><?php if ($_smarty_tpl->tpl_vars['action']->value!="different_only") {?><a class="ty-compare-menu__a" href="<?php echo htmlspecialchars(fn_url("product_features.compare.different_only"), ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                    <td class="ty-compare-products__product">
                        ...
                        <div class="ty-compare-products__item">
                            <div class="ty-compare-products__delete"><a href="<?php echo htmlspecialchars(fn_url("product_features.delete_product?product_id=".((string)$_smarty_tpl->tpl_vars['compare_product_id']->value)."&redirect_url=".((string)$_smarty_tpl->tpl_vars['return_current_url']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
"><i class="ty-remove__icon ty-icon-cancel-circle"></i><span class="ty-remove__txt"><?php echo $_smarty_tpl->__("remove");?>
                            ...
                            <div class="ty-compare-products__img"><a href="<?php echo htmlspecialchars(fn_url("products.view?product_id=".((string)$_smarty_tpl->tpl_vars['compare_product_id']->value)), ENT_QUOTES, 'ISO-8859-1');?>
"><?php echo $_smarty_tpl->getSubTemplate ("common/image.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('image_width'=>$_smarty_tpl->tpl_vars['settings']->value['Thumbnails']['product_lists_thumbnail_width'],'image_height'=>$_smarty_tpl->tpl_vars['settings']->value['Thumbnails']['product_lists_thumbnail_height'],'obj_id'=>$_smarty_tpl->tpl_vars['product']->value['product_id'],'images'=>$_smarty_tpl->tpl_vars['product']->value['main_pair'],'no_ids'=>true), 0);?>
                        ...
                        <div class="ty-compare-products__item">
                            <a href="<?php echo htmlspecialchars(fn_url("products.view?product_id=".((string)$_smarty_tpl->tpl_vars['compare_product_id']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
?>
                        <tr class="ty-compare-feature__row">
                            <td class="ty-compare-feature__item ty-compare-sort">
                                <strong class="ty-compare-sort__title"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_feature']->value, ENT_QUOTES, 'ISO-8859-1');?>
:</strong>
                                    <a href="<?php echo htmlspecialchars(fn_url("product_features.delete_feature?feature_id=".((string)$_smarty_tpl->tpl_vars['id']->value)."&redirect_url=".((string)$_smarty_tpl->tpl_vars['return_current_url']->value)), ENT_QUOTES, 'ISO-8859-1');?>
...
if ($_smarty_tpl->tpl_vars['var']->value['selected']) {?><li class="ty-compare-list__item"><span class="ty-compare-checkbox" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['var']->value['variant'], ENT_QUOTES, 'ISO-8859-1');?>
"><i class="ty-compare-checkbox__icon ty-icon-ok"></i></span>&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['prefix'], ENT_QUOTES, 'ISO-8859-1');?>
&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['var']->value['variant'], ENT_QUOTES, 'ISO-8859-1');?>
&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['feature']->value['suffix'], ENT_QUOTES, 'ISO-8859-1');?>
</li><?php }
