                ...
                <tr>
                    ...
                    {foreach from=$comparison_data.products item=product}
                        ...
                        {/hook}
                            ...
                            <div class="ty-compare-products__item">{include file="blocks/list_templates/simple_list.tpl" min_qty=true product=$product show_qty=false show_rating=true show_add_to_cart=false show_discount_label=true but_role="action" hide_price=true}
                            </div>
                        </td>
                    {/foreach}
                </tr>
