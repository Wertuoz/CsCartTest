                        ...
                        <div class="ab-product-content-wrap">
                            <div class="ty-pd-list__image">
                                <div class="grid-list-buttons">
                                    {if !$quick_view && $block.properties.enable_quick_view == "Y"}
                            ...
                            <div class="ty-pd-list__item-name">
                                ...
                                {else}
                                    <div class="grid-list__rating no-rating"><span class="ty-nowrap ty-stars"><i class="ty-icon-star-empty"></i><i class="ty-icon-star-empty"></i><i class="ty-icon-star-empty"></i><i class="ty-icon-star-empty"></i><i class="ty-icon-star-empty"></i></span></div>
                                {/if}
                                {assign var="name" value="name_$obj_id"}
                                {$smarty.capture.$name nofilter}
                            </div>
                            <div class="ty-pd-list__price {if $product.price == 0}ty-pd-list__no-price{/if}">
                                <div class="pd-price-item {if $block.properties.item_quantity > 3}text-center{/if}">
